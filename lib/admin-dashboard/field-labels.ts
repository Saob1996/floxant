const FIELD_LABELS: Record<string, string> = {
  ...
  accessPath: "Zugangsweg",
  accessTimes: "Zugangszeiten",
  accessWidth: "Verfügbare Durchgangsbreite",
  ...
  material: "Material",
  message: "Nachricht",
  missingInfoFlags: "Offene Angaben",
  ...
  remainingItems: "Restgegenstände",
  ...
  utm_term: "UTM Term",
  wbraid: "WBRAID",
  vehicleDistance: "Entfernung zum Fahrzeug",
  weight: "Gewicht",
  windowCount: "Anzahl Fenster",
  windowsCount: "Fenster",
  zip: "PLZ",
  "configuration.serviceRequest.item.description": "Möbel oder Gegenstände",
  "configuration.serviceRequest.access.width": "Verfügbare Durchgangsbreite",
  "configuration.serviceRequest.access.path": "Zugangsweg",
};
