...
const englishTemplates: ReplyTemplate[] = [
  ...
  { id: "en-missing_details", key: "missing_details", locale: "en", label: "Request missing details", subject: "Details needed for your FLOXANT request", body: "{{greeting}},\n\nthe following details are still needed for a manual review: {{missingDetails}}. Please send only information that is necessary for the service request.\n\nKind regards\nFLOXANT" },
  ...
  { id: "en-quote_preparation", key: "quote_preparation", locale: "en", label: "Quote preparation", subject: "Review of your FLOXANT request", body: "{{greeting}},\n\nthe details for {{service}} are being prepared for further manual review. We will ask specific questions if information is missing. This message is not yet a quote or appointment confirmation.\n\nKind regards\nFLOXANT" },
