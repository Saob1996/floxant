...
export const trustSignals: TrustSignal[] = [
  {
    ...
    cta: { label: "Anfrage sauber starten", href: "/kontakt?mode=neutral&source=trust-proof" },
  ...
  },
  {
    ...
    cta: { label: "Diskret anfragen", href: "/kontakt?mode=neutral&source=trust-proof" },
  ...
  },
  {
    ...
    cta: { label: "B2B-Anfrage starten", href: "/kontakt?mode=neutral&source=trust-proof" },
  ...
  },
  {
    ...
    cta: { label: "Kontaktweg pruefen", href: "/kontakt?mode=neutral&source=trust-proof" },
  ...
  },
  {
    ...
    cta: { label: "Plan B einordnen", href: "/kontakt?mode=neutral&source=trust-proof" },
  ...
  },
  {
    ...
    cta: { label: "Anfrage mit sicheren Fotos starten", href: "/kontakt?mode=neutral&source=trust-proof" },
