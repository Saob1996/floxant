...
export const visualProofItems: VisualProofItem[] = [
  ...
  },
  {
    ...
    description: "Neutrale Übersicht für Düsseldorf und Regensburg ohne persönliche Standortdaten.",
    alt: "Neutrale Übersicht für zwei FLOXANT Regionen",
    isRealPhoto: false,
    isBeforeAfter: false,
    privacyChecked: true,
    consentStatus: "not-needed",
  ...
  },
  {
    ...
    description: "Nicht sichtbar, solange Freigabe und Einwilligung fehlen.",
