...
export const visualProofItems: VisualProofItem[] = [
  ...
  },
  {
    ...
    description: "Abstrakte Standortübersicht für Düsseldorf und Regensburg ohne Kartenausschnitt.",
    alt: "Abstrakte Übersicht der FLOXANT Standorte Düsseldorf und Regensburg",
    isRealPhoto: false,
    isBeforeAfter: false,
    privacyChecked: true,
    consentStatus: "not-needed",
