...
const duesseldorfEnglishSpecs = [
  ...
  },
  {
    ...
    scope: ["occupied homes", "empty flats", "kitchens", "bathrooms", "handover preparation"],
    customerTypes: ["tenants", "landlords", "international residents", "relocation customers"],
    typicalCases: ["one-time clean", "empty apartment", "before guests arrive", "handover preparation"],
  },
  {
    path: "/en/duesseldorf/deep-cleaning",
    serviceKey: "grundreinigung",
    serviceName: "Deep cleaning",
    scope: ["heavy dirt", "renovation dust", "kitchens", "bathrooms", "surface-specific cleaning"],
    customerTypes: ["tenants", "landlords", "companies", "property managers"],
    typicalCases: ["after renovation", "long vacancy", "heavy use", "before a new service schedule"],
  },
  {
    path: "/en/duesseldorf/move-out-cleaning",
    serviceKey: "reinigung-nach-umzug",
    serviceName: "Move-out cleaning",
    scope: ["empty apartments", "kitchens", "bathrooms", "floors", "key handover"],
    customerTypes: ["tenants", "landlords", "international residents", "relocation customers"],
    typicalCases: ["key return", "apartment handover", "after furniture removal", "fixed handover date"],
  },
  {
