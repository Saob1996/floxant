...
export const aiAnswerEntries: AiAnswerEntry[] = [
  ...
  },
  {
    ...
    cta: { href: "/kontakt?service=solarreinigung&intent=solarreinigung-anfragen&source=seo", label: "Solarfall pruefen" },
  ...
  },
  {
    ...
    cta: { href: "/kontakt?service=uebergabe-sprint&intent=uebergabe-sprint&source=seo", label: "Uebergabe vorbereiten" },
  ...
  },
  {
    ...
    cta: { href: "/kontakt?intent=english-request&source=seo", label: "Send English request" },
