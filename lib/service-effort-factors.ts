...
export const serviceEffortFactors: Record<EffortFactorGroup, EffortFactorDefinition> = {
  reinigung: {
    ...
    factors: [
      ...
      { key: "turnus", label: "Turnus", whyItMatters: "Einmalig, woechentlich oder mehrmals pro Woche veraendert Planung und Aufwand.", helpfulInput: "Gewünschten Rhythmus nennen." },
  ...
  entruempelung: {
    ...
    factors: [
      ...
      { key: "sensibel", label: "Sensible Situation", whyItMatters: "Nachlass, Trennung oder belastende Lage brauchen ruhige Abstimmung.", helpfulInput: "Gewünschten Kontaktweg nennen." },
