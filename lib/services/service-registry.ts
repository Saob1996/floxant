...
const seeds: readonly ServiceSeed[] = [
  ...
  },
  {
    ...
    canonicalRoute: "/regensburg/reinigung-nach-umzug", englishAlternativeRoute: "/en/regensburg/move-out-cleaning",
    additionalRoutes: ["/endreinigung-regensburg", "/regensburg/endreinigung", "/regensburg/uebergabereinigung", "/regensburg/besenreine-uebergabe"], hubRoutes: ["/leistungen", "/regensburg"],
    legacyRoutePatterns: ["^/regensburg/(?:besenreine-uebergabe|endreinigung|uebergabereinigung)$", "^/(?:endreinigung-regensburg|reinigungsgarantie)$"],
  ...
  },
  {
    ...
    audienceTypes: ["private", "business"], germanName: "Seniorenumzug", englishName: "Senior moving service",
    ...
    regions: ["Regensburg"], targetAudiences: ["Seniorinnen und Senioren", "Angehörige", "Betreuungen und Sozialdienste"],
    canonicalRoute: "/regensburg/seniorenumzug", additionalRoutes: [],
  ...
  },
  {
    ...
    requiredDetails: ["Start", "Ziel", "Zeitfenster", "Transportgut", "Volumen", "Fotos"], canonicalRoute: "/leerfahrt-rueckfahrt",
  ...
  },
  {
    ...
    regions: ["Düsseldorf", "Regensburg"], targetAudiences: ["Privathaushalte", "Vermieter", "Unternehmen"],
    ...
    regionalPrimaryRoutes: { Düsseldorf: "/duesseldorf/entruempelung", Regensburg: "/regensburg/entruempelung" },
    englishAlternativeRoute: "/en/regensburg/house-clearance", additionalRoutes: ["/entruempelung"], hubRoutes: ["/leistungen", "/duesseldorf", "/regensburg"],
    ...
    evidence: [publicPage("app/duesseldorf/entruempelung/page.tsx"), publicPage("app/entruempelung/page.tsx"), publicPage("app/regensburg/entruempelung/page.tsx")],
  },
  {
  ...
  },
  {
    ...
    canonicalRoute: "/regensburg/wohnungsaufloesung", additionalRoutes: ["/regensburg/haushaltsaufloesung"], hubRoutes: ["/leistungen", "/regensburg"],
  ...
  },
  {
    ...
    canonicalRoute: "/angebot-guenstiger-pruefen", englishAlternativeRoute: "/en/regensburg/cleaning-quote-review",
    additionalRoutes: ["/angebotscheck", "/angebot-pruefen", "/en/duesseldorf/cleaning-quote-review"], hubRoutes: ["/leistungen", "/signature-services", "/duesseldorf", "/regensburg"],
  ...
  },
  {
    ...
    canonicalRoute: "/angebot-guenstiger-pruefen", additionalRoutes: ["/fairpreis-check"], hubRoutes: ["/signature-services"], relatedServiceIds: ["angebotscheck"],
  ...
  },
  {
    ...
    canonicalRoute: "/leerfahrt-rueckfahrt", additionalRoutes: ["/rueckfahrt-radar"], hubRoutes: ["/signature-services"], relatedServiceIds: ["beiladung-rueckfahrt"],
    evidenceStatus: "MANUAL_REVIEW_REQUIRED", evidence: [publicRegistry("lib/signature-special-services.ts", "Öffentliche Referenz vorhanden, statische Zielseite fehlt.")],
  },
  {
