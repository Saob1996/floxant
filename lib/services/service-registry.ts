...
const seeds: readonly ServiceSeed[] = [
  ...
  },
  {
    ...
    canonicalRoute: "/praxisreinigung-regensburg", englishAlternativeRoute: "/en/duesseldorf/practice-cleaning",
  ...
  },
  {
    ...
    canonicalRoute: "/fensterreinigung-regensburg", englishAlternativeRoute: "/en/duesseldorf/window-cleaning",
  ...
  },
  {
    ...
    regions: ["Regensburg"], objectTypes: ["Wohnung", "Büro", "Küche", "Bad", "Objektfläche"],
    canonicalRoute: "/grundreinigung-regensburg", englishAlternativeRoute: "/en/regensburg/deep-cleaning",
    hubRoutes: ["/leistungen", "/regensburg"], relatedServiceIds: ["reinigung", "endreinigung"], evidence: [publicPage("app/grundreinigung-regensburg/page.tsx")],
  },
  {
    ...
    regions: ["Regensburg"], targetAudiences: ["Unternehmen", "Praxen", "Hausverwaltungen"],
    canonicalRoute: "/unterhaltsreinigung-regensburg", hubRoutes: ["/leistungen", "/regensburg"],
    relatedServiceIds: ["bueroreinigung", "gewerbereinigung", "treppenhausreinigung"], evidenceStatus: "PARTIALLY_VERIFIED",
    evidence: [publicPage("app/unterhaltsreinigung-regensburg/page.tsx")],
  },
  {
    ...
    regions: ["Regensburg"], targetAudiences: ["Hausverwaltungen", "Eigentümergemeinschaften"],
  ...
  },
  {
    ...
    regions: ["Regensburg"], excludedServices: ["Sanierung", "Baumängelhaftung", "Gefahrstoff- oder Asbestarbeiten"],
    canonicalRoute: "/baureinigung-regensburg", hubRoutes: ["/leistungen", "/regensburg"],
    relatedServiceIds: ["grundreinigung", "endreinigung"], evidenceStatus: "PARTIALLY_VERIFIED", evidence: [publicPage("app/baureinigung-regensburg/page.tsx")],
  },
  {
  ...
  },
  {
    ...
    canonicalRoute: "/regensburg/umzug", englishAlternativeRoute: "/en/regensburg/moving", additionalRoutes: ["/umzug"],
    legacyRoutePatterns: [
  ...
  },
  {
    ...
    canonicalRoute: "/klaviertransport-regensburg", additionalRoutes: ["/klaviertransport"], hubRoutes: ["/leistungen", "/regensburg"],
  ...
  },
  {
    ...
    regions: ["Regensburg"], canonicalRoute: "/regensburg/wohnungsaufloesung", englishAlternativeRoute: "/en/regensburg/apartment-clearance",
