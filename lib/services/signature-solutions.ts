...
export const signatureSolutions: readonly SignatureSolution[] = [
  {
    ...
    result: "Eine strukturierte Liste nachvollziehbarer Punkte, offener Angaben und möglicher Rückfragen.",
  ...
  },
  {
    ...
    kind: "SIGNATURE",
    actualFunction:
      "Sammelt Objektart, Region, Ort, Termin, Zugang, Fotos und Zielzustand in einer strukturierten Anfrage.",
  ...
  },
  {
    ...
    result: "Eine zurückhaltend strukturierte Anfrage mit bevorzugtem Kontaktweg und nur den nötigen Eckdaten.",
