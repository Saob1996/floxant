...
export const signatureSolutions: readonly SignatureSolution[] = [
  {
    ...
    cta: { label: "Angebot einordnen", href: "/angebot-guenstiger-pruefen" },
    canonicalRoute: "/angebot-guenstiger-pruefen",
  ...
  },
  {
    ...
    cta: { label: "Nicht öffentlich", href: "/angebot-guenstiger-pruefen" },
    canonicalRoute: "/angebot-guenstiger-pruefen",
  ...
  },
  {
    ...
    cta: { label: "Rückfahrt prüfen", href: "/leerfahrt-rueckfahrt" },
    canonicalRoute: "/leerfahrt-rueckfahrt",
    evidence: [registry("lib/signature-special-services.ts", "Name und Zielroute werden referenziert, eine statische Zielseite fehlt.")],
    evidenceStatus: "MANUAL_REVIEW_REQUIRED",
    publicAllowed: false,
    lastReviewedAt: reviewedAt,
  ...
  },
  {
    ...
    cta: { label: "Nicht öffentlich", href: "/kontakt?mode=neutral&source=website" },
