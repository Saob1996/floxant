...
export const REQUEST_FORM_PROFILES = Object.freeze({
  cleaning: Object.freeze({
    ...
    optionalFields: Object.freeze(["scope", "frequency", "desiredDate", "condition", "accessPath", "windowCount", "upgrades", "message", "files"]),
...
export const REQUEST_SERVICE_POLICY = Object.freeze([
  ...
  service({ id: "solarreinigung", name: "Solarreinigung", category: "cleaning", locations: both, leadService: "solarreinigung", formProfile: "cleaning" }),
  service({ id: "pv-anlagen-reinigung", name: "PV-Anlagen-Reinigung", category: "cleaning", locations: both, leadService: "pv-anlagen-reinigung", formProfile: "cleaning" }),
  ...
  service({ id: "fernumzug", name: "Fernumzug", category: "moving", locations: regensburg, leadService: "fernumzug", formProfile: "moving", allowedUpgrades: movingUpgrades }),
  ...
  service({ id: "private-client", name: "FLOXANT Private Client Service", category: "general", locations: both, leadService: "private-client", formProfile: "general" }),
]);
...
export const REQUEST_UNSURE_SERVICES = Object.freeze([
  ...
  service({ id: "fernumzug", name: "Fernumzug", category: "moving", locations: ["unsicher"], leadService: "fernumzug", formProfile: "moving", allowedUpgrades: movingUpgrades }),
  service({ id: "solarreinigung", name: "Solarreinigung", category: "cleaning", locations: ["unsicher"], leadService: "solarreinigung", formProfile: "cleaning" }),
  service({ id: "pv-anlagen-reinigung", name: "PV-Anlagen-Reinigung", category: "cleaning", locations: ["unsicher"], leadService: "pv-anlagen-reinigung", formProfile: "cleaning" }),
  ...
  service({ id: "angebotscheck", name: "FLOXANT Angebotscheck", category: "offer_check", locations: ["unsicher"], leadService: "angebot-pruefen", formProfile: "offer_check" }),
  service({ id: "diskret-service", name: "FLOXANT Diskret-Service", category: "clearance", locations: ["unsicher"], leadService: "diskret-service", formProfile: "general" }),
  service({ id: "private-client", name: "FLOXANT Private Client Service", category: "general", locations: ["unsicher"], leadService: "private-client", formProfile: "general" }),
