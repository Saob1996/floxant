...
export const REQUEST_FORM_PROFILES = Object.freeze({
  cleaning: Object.freeze({
    ...
    optionalFields: Object.freeze(["objectType", "areaSize", "frequency", "desiredDate", "condition", "accessPath", "windowCount", "upgrades", "message", "files"]),
  ...
  clearance: Object.freeze({
    coreFields: Object.freeze(["cityOrZip", "areaSize"]),
    optionalFields: Object.freeze(["objectType", "floor", "elevator", "desiredDate", "scope", "fillLevel", "accessPath", "cleaningRequested", "message", "files"]),
...
export const REQUEST_SERVICE_POLICY = Object.freeze([
  ...
  service({ id: "entruempelung", name: "Entrümpelung", category: "clearance", locations: both, leadService: "entruempelung", formProfile: "clearance" }),
