...
export const serviceInventory: readonly ServiceInventoryItem[] = [
  ...
  buildService({
    ...
    priority: "P1",
    seoIntent: "Haushaltsaufloesung respektvoll und mit konkreten Eckdaten anfragen",
  }),
  buildService({
  ...
  buildService({
    ...
    category: "signature_service",
    shortDescription: "Hilft, zwischen Direktanfrage, Angebotsprüfung, Objektbrief oder Plan B zu waehlen.",
