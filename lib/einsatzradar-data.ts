...
export const einsatzradarRegionZones: EinsatzradarZone[] = ([
  {
    ...
    description: "Regensburg ist der feste Ausgangspunkt von FLOXANT. Hier lassen sich Umzug, Reinigung, Entruempelung, Transport, Uebergabeakte und Mieterwechsel besonders gut abstimmen.",
...
export const einsatzradarEntries: EinsatzradarEntry[] = ([
  ...
  },
  {
    ...
    signature_services: ["Diskrete Abstimmung", "Uebergabeakte", "Angebotscheck"],
    customer_type: "Eigentuemer, Familien, sensible Faelle",
    cta_label: "Diskrete Anfrage starten",
...
export const einsatzradarFaq = [
  ...
  },
  {
    ...
    a: "Nur nach Zustimmung, anonymisiert, ohne personenbezogene Daten und ohne exakte Adresse. Ohne Freigabe bleibt Ihr Auftrag vertraulich bei FLOXANT.",
  },
].map((item) => ({
  q: radarText(item.q),
  a: radarText(item.a),
