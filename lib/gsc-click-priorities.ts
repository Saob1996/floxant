...
const privateClientAnchors = [
  ...
  { href: "/diskret-service", label: "Diskret-Service fuer sensible Faelle" },
...
const diskretServiceAnchors = [
  ...
  { href: "/nachlass-raeumung-regensburg", label: "Nachlassraeumung diskret klaeren" },
  { href: "/angebot-guenstiger-pruefen", label: "Diskretes Angebot pruefen" },
  { href: "/private-client-service", label: "Private Client Service" },
...
export const gscClickPriorities = {
  ...
  "/regensburg/endreinigung": {
    ...
    secondaryKeywords: [
      ...
      "uebergabereinigung regensburg",
      "reinigung nach entruempelung regensburg",
      "wohnung uebergabefertig machen",
  ...
  "/entruempelung-landshut": {
    ...
    primaryKeyword: "reinigung nach entruempelung landshut",
    secondaryKeywords: [
  ...
  "/diskret-service": {
    ...
    title: "Diskret-Service fuer sensible Anfragen",
    description:
  ...
  "/private-client-service": {
    ...
    secondaryKeywords: [
      ...
      "persoenliche servicekoordination",
  ...
  "/regensburg/umzug": {
    ...
    description:
      "Umzug Regensburg anfragen: Start, Ziel, Etage, Laufweg, Fotos, Terminwunsch und vorhandenes Angebot vor der Zusage klaeren.",
  ...
  "/regensburg/entruempelung": {
    ...
    title: "Entruempelung Regensburg mit Raeumen und Zugang",
    description:
      "Entruempelung Regensburg anfragen: Raeume, Menge, Zugang, Fotos, Frist, Entsorgung, Reinigung danach und Angebot strukturiert klaeren.",
    openGraphTitle: "Entruempelung Regensburg anfragen",
    openGraphDescription:
      "Raeumung in Regensburg mit Fotos, Menge, Zugang, Zielzustand und Anschlussreinigung vorbereiten.",
    h1: "Entruempelung Regensburg mit Raeumen, Menge und Zugang",
    pageIntent: "Entruempelung in Regensburg mit Menge, Fotos, Zugang und Angebot anfragen",
    primaryKeyword: "entruempelung regensburg",
    secondaryKeywords: ["wohnungsaufloesung regensburg", "haushaltsaufloesung regensburg", "raeumungsangebot regensburg"],
    jsonLdTypes: ["WebPage", "Service", "BreadcrumbList", "FAQPage"],
    internalLinkAnchors: [
      { href: "/regensburg/reinigung", label: "Reinigung nach Entruempelung Regensburg" },
      { href: "/regensburg/haushaltsaufloesung", label: "Haushaltsaufloesung Regensburg" },
      { href: "/angebot-guenstiger-pruefen", label: "Entruempelungsangebot pruefen" },
      { href: "/kontakt?service=entruempelung&city=regensburg&intent=entruempelungsangebot-pruefen&source=seo", label: "Raeumungsangebot einordnen" },
    ],
  },
  ...
  "/regensburg/bueroreinigung": {
    ...
    title: "B2B Bueroreinigung mit Raumliste und Angebot",
    description:
      "B2B Bueroreinigung fuer Firmen: Flaeche, Raumliste, Turnus, Zeitfenster, Zugang und vorhandenes Angebot sachlich klaeren.",
    openGraphTitle: "B2B Bueroreinigung anfragen",
    openGraphDescription:
      "FLOXANT ordnet Bueroreinigung fuer Firmen nach Objekt, Turnus, Flaeche, Zeitfenster und Ansprechpartner ein.",
    h1: "B2B Bueroreinigung fuer Firmen mit klarer Angebotsanfrage",
    pageIntent: "B2B-Bueroreinigung fuer Firmen und Gewerbe mit Raumliste und Angebot anfragen",
    primaryKeyword: "b2b bueroreinigung",
    secondaryKeywords: [
      "bueroreinigung firma",
      "bueroreinigung fuer unternehmen",
  ...
  "/regensburg/reinigung": {
    ...
    path: "/regensburg/reinigung",
    canonical: "/regensburg/reinigung",
    title: "Reinigung Regensburg mit Objekt und Angebot klaeren",
    description:
      "Reinigung Regensburg fuer Wohnung, Buero, Praxis, Treppenhaus oder Grundreinigung: Fotos, Flaeche, Termin und Angebot klar senden.",
  ...
  "/regensburg/gewerbereinigung": {
    ...
    title: "Gewerbereinigung Regensburg fuer Buero und Objekt",
    description:
      "Gewerbereinigung Regensburg fuer Buero, Praxis, Kanzlei, Hotel und Objekt: Flaeche, Turnus, Zeitfenster, Zugang und Fotos senden.",
