...
Generated: 2026-08-28T23:01:32.735Z
Status: WARN
...
| PASS | P0 | metadata | / | Title found: FLOXANT \| Reinigung Düsseldorf & Services Regensburg | No action. |
| PASS | P0 | metadata | / | Meta description found. | No action. |
| PASS | P0 | html | / | H1: Reinigung in Düsseldorf. Umzug und Service in Regensburg. | No action. |
...
| PASS | P0 | contact-link | / | Contact link found: /kontakt | No action. |
...
| PASS | P0 | contact-link | /leistungen | Contact link found: /kontakt | No action. |
| PASS | P0 | route | /kontakt | HTTP 200 | No action. |
| PASS | P0 | html | /kontakt | No obvious application/hydration error marker. | No action. |
| PASS | P0 | metadata | /kontakt | Title found: Leistung unverbindlich anfragen \| FLOXANT | No action. |
| PASS | P0 | metadata | /kontakt | Meta description found. | No action. |
| PASS | P0 | html | /kontakt | H1: Leistung unverbindlich anfragen | No action. |
...
| PASS | P0 | contact-link | /kontakt | Contact link found: /kontakt | No action. |
...
| PASS | P0 | contact-link | /angebot-guenstiger-pruefen | Contact link found: /kontakt | No action. |
...
| PASS | P0 | metadata | /angebotscheck | Title found: Angebotscheck: 12 Punkte zum Leistungsumfang \| FLOXANT | No action. |
| PASS | P0 | metadata | /angebotscheck | Meta description found. | No action. |
| PASS | P0 | html | /angebotscheck | H1: Zwölf Punkte eines Angebots einzeln klären | No action. |
...
| PASS | P0 | contact-link | /angebotscheck | Contact link found: /kontakt | No action. |
...
| PASS | P0 | contact-link | /anbieter-vergleichen | Contact link found: /kontakt | No action. |
...
| PASS | P0 | metadata | /duesseldorf | Title found: FLOXANT Düsseldorf \| Reinigung für Büro, Praxis & Objekt | No action. |
| PASS | P0 | metadata | /duesseldorf | Meta description found. | No action. |
| PASS | P0 | html | /duesseldorf | H1: FLOXANT Düsseldorf für Reinigung von Büro, Praxis und Objekt. | No action. |
...
| PASS | P0 | contact-link | /duesseldorf | Contact link found: /kontakt | No action. |
...
| PASS | P0 | metadata | /duesseldorf/reinigung | Title found: Reinigungsfirma Düsseldorf \| Angebot anfragen \| FLOXANT | No action. |
| PASS | P0 | metadata | /duesseldorf/reinigung | Meta description found. | No action. |
| PASS | P0 | html | /duesseldorf/reinigung | H1: Reinigungsfirma in Düsseldorf für Wohnung, Büro und Objekt | No action. |
...
| PASS | P0 | contact-link | /duesseldorf/reinigung | Contact link found: /kontakt | No action. |
...
| PASS | P0 | metadata | /duesseldorf/bueroreinigung | Title found: Büroreinigung Düsseldorf \| Turnus planen \| FLOXANT | No action. |
| PASS | P0 | metadata | /duesseldorf/bueroreinigung | Meta description found. | No action. |
| PASS | P0 | html | /duesseldorf/bueroreinigung | H1: Büroreinigung in Düsseldorf planbar und klar anfragen | No action. |
...
| PASS | P0 | contact-link | /duesseldorf/bueroreinigung | Contact link found: /kontakt | No action. |
...
| PASS | P0 | metadata | /duesseldorf/gewerbereinigung | Title found: Gewerbereinigung Düsseldorf: Objekt & Turnus \| FLOXANT | No action. |
| PASS | P0 | metadata | /duesseldorf/gewerbereinigung | Meta description found. | No action. |
| PASS | P0 | html | /duesseldorf/gewerbereinigung | H1: Gewerbereinigung in Düsseldorf nach Objekt und Nutzung planen | No action. |
...
| PASS | P0 | contact-link | /duesseldorf/gewerbereinigung | Contact link found: /kontakt | No action. |
...
| PASS | P0 | metadata | /duesseldorf/praxisreinigung | Title found: Praxisreinigung Düsseldorf \| Ablauf & Angebot \| FLOXANT | No action. |
| PASS | P0 | metadata | /duesseldorf/praxisreinigung | Meta description found. | No action. |
| PASS | P0 | html | /duesseldorf/praxisreinigung | H1: Praxisreinigung in Düsseldorf mit Räumen und Zeiten anfragen | No action. |
...
| PASS | P0 | contact-link | /duesseldorf/praxisreinigung | Contact link found: /kontakt | No action. |
...
| PASS | P0 | metadata | /duesseldorf/fensterreinigung | Title found: Fensterreinigung Düsseldorf: Glasflächen & Angebot | No action. |
| PASS | P0 | metadata | /duesseldorf/fensterreinigung | Meta description found. | No action. |
| PASS | P0 | html | /duesseldorf/fensterreinigung | H1: Fensterreinigung in Düsseldorf mit Glasflächen und Zugang anfragen | No action. |
...
| PASS | P0 | contact-link | /duesseldorf/fensterreinigung | Contact link found: /kontakt | No action. |
...
| PASS | P1 | metadata | /duesseldorf/hausverwaltung-reinigung | Title found: FLOXANT Düsseldorf \| Reinigung für Büro, Praxis & Objekt | No action. |
| PASS | P1 | metadata | /duesseldorf/hausverwaltung-reinigung | Meta description found. | No action. |
| PASS | P1 | html | /duesseldorf/hausverwaltung-reinigung | H1: FLOXANT Düsseldorf für Reinigung von Büro, Praxis und Objekt. | No action. |
...
| PASS | P1 | contact-link | /duesseldorf/hausverwaltung-reinigung | Contact link found: /kontakt | No action. |
...
| PASS | P0 | contact-link | /regensburg | Contact link found: /kontakt | No action. |
...
| PASS | P0 | contact-link | /umzug-regensburg | Contact link found: /kontakt | No action. |
...
| PASS | P0 | contact-link | /reinigung-regensburg | Contact link found: /kontakt | No action. |
...
| PASS | P0 | contact-link | /entruempelung-regensburg | Contact link found: /kontakt | No action. |
...
| PASS | P0 | contact-link | /gewerbereinigung-regensburg | Contact link found: /kontakt | No action. |
...
| PASS | P0 | contact-link | /bueroreinigung-regensburg | Contact link found: /kontakt | No action. |
...
| PASS | P0 | contact-link | /klaviertransport-regensburg | Contact link found: /kontakt | No action. |
...
| PASS | P1 | contact-link | /wohnungsaufloesung-regensburg | Contact link found: /kontakt | No action. |
...
| PASS | P0 | contact-link | /diskret-service | Contact link found: /kontakt | No action. |
...
| PASS | P1 | contact-link | /private-client-service | Contact link found: /kontakt?location=unsicher&service=private-client&city=bayern&intent=private-client-service&source=seo | No action. |
...
| PASS | P0 | contact-link | /seniorenumzug-bayern | Contact link found: /kontakt | No action. |
...
| PASS | P0 | contact-link | /solarreinigung | Contact link found: /kontakt | No action. |
...
| PASS | P0 | contact-link | /pv-anlagen-reinigung | Contact link found: /kontakt | No action. |
...
| PASS | P1 | metadata | /objektbrief | Title found: Anfragebrief für Reinigung, Umzug oder Räumung \| FLOXANT | No action. |
| PASS | P1 | metadata | /objektbrief | Meta description found. | No action. |
| WARN | P1 | html | /objektbrief | H1: Leistung, Ort und Umfang für eine klare Anfrage vorbereiten | Expected H1 to contain one of: Objektbrief |
...
| PASS | P1 | contact-link | /objektbrief | Contact link found: /kontakt | No action. |
...
| PASS | P1 | contact-link | /uebergabe-sprint | Contact link found: /kontakt | No action. |
...
| PASS | P1 | contact-link | /vermieter-ready-service | Contact link found: /kontakt | No action. |
...
| PASS | P1 | contact-link | /leerfahrt-rueckfahrt | Contact link found: /kontakt | No action. |
...
| PASS | P0 | technical | /sitemap.xml | 391 sitemap URLs found. | No action. |
