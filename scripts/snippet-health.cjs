...
const targets = [
  ...
  { route: "/regensburg/bueroreinigung", service: "bueroreinigung", city: "regensburg", offer: true, cta: ["/reinigungsfirma-angebot", "/angebot-guenstiger-pruefen", "/kontakt"] },
  { route: "/regensburg/gewerbereinigung", service: "gewerbereinigung", city: "regensburg", offer: true, cta: ["/angebot-guenstiger-pruefen", "/kontakt"] },
  { route: "/praxisreinigung-regensburg", service: "praxisreinigung", city: "regensburg", offer: true, cta: ["/reinigungsfirma-angebot", "/kontakt"] },
  { route: "/fensterreinigung-regensburg", service: "fensterreinigung", city: "regensburg", offer: true, cta: ["/reinigungsfirma-angebot", "/kontakt"] },
