...
const criticalRoutes = [
  ...
  { path: "/duesseldorf/einsatzgebiet", expectedStatus: 200, expectedH1Contains: ["Einsatzgebiet", "Reinigung", "Düsseldorf"], mustHaveCanonical: true, mustHaveMetaDescription: true, mustHaveCta: true, mustHaveContactLink: true, mustHaveNoFakeClaims: true, mustNotHaveNoindex: true, expectedService: "reinigung", expectedCity: "duesseldorf", expectedIntent: "einsatzgebiet-anfrage", priority: "P0", moneyPage: true },
  ...
  { path: "/region-regensburg", expectedStatus: 200, expectedH1Contains: ["Einsatzgebiet", "Regensburg"], mustHaveCanonical: true, mustHaveMetaDescription: true, mustHaveCta: true, mustHaveContactLink: true, mustHaveNoFakeClaims: true, mustNotHaveNoindex: true, expectedService: "umzug", expectedCity: "regensburg", expectedIntent: "einsatzgebiet-anfrage", priority: "P0", moneyPage: true },
  ...
  { path: "/private-client-service", optional: true, expectedStatus: 200, expectedH1Contains: ["Private", "Client", "Diskret"], mustHaveCanonical: true, mustHaveMetaDescription: true, mustHaveCta: true, mustHaveContactLink: true, localContactTarget: "#private-anfrage", mustHaveNoFakeClaims: true, mustNotHaveNoindex: true, expectedService: "private-client-service", expectedCity: "deutschland", expectedIntent: "private-client-service", priority: "P1", moneyPage: true },
