...
const criticalRoutes = [
  ...
  { path: "/duesseldorf/grundreinigung", expectedStatus: 200, expectedH1Contains: ["Grundreinigung", "Düsseldorf"], mustHaveCanonical: true, mustHaveMetaDescription: true, mustHaveCta: true, mustHaveContactLink: true, mustHaveNoFakeClaims: true, mustNotHaveNoindex: true, expectedService: "grundreinigung", expectedCity: "duesseldorf", expectedIntent: "grundreinigung-duesseldorf", priority: "P0", moneyPage: true },
  { path: "/duesseldorf/unterhaltsreinigung", expectedStatus: 200, expectedH1Contains: ["Unterhaltsreinigung", "Düsseldorf"], mustHaveCanonical: true, mustHaveMetaDescription: true, mustHaveCta: true, mustHaveContactLink: true, mustHaveNoFakeClaims: true, mustNotHaveNoindex: true, expectedService: "unterhaltsreinigung", expectedCity: "duesseldorf", expectedIntent: "unterhaltsreinigung-duesseldorf", priority: "P0", moneyPage: true },
  { path: "/duesseldorf/baureinigung", expectedStatus: 200, expectedH1Contains: ["Bauendreinigung", "Baureinigung", "Düsseldorf"], mustHaveCanonical: true, mustHaveMetaDescription: true, mustHaveCta: true, mustHaveContactLink: true, mustHaveNoFakeClaims: true, mustNotHaveNoindex: true, expectedService: "baureinigung", expectedCity: "duesseldorf", expectedIntent: "baureinigung-duesseldorf", priority: "P0", moneyPage: true },
  ...
  { path: "/fragen", expectedStatus: 200, expectedH1Contains: ["Fragen", "Antworten"], mustHaveCanonical: true, mustHaveMetaDescription: true, mustHaveCta: true, mustHaveContactLink: true, mustHaveNoFakeClaims: true, mustNotHaveNoindex: true, expectedService: "multi", expectedCity: "deutschland", expectedIntent: "fragen", priority: "P0" },
  { path: "/rechner", expectedStatus: 200, expectedH1Contains: ["Rechner", "Aufwand"], mustHaveCanonical: true, mustHaveMetaDescription: true, mustHaveCta: true, mustHaveContactLink: true, mustHaveNoFakeClaims: true, mustNotHaveNoindex: true, expectedService: "multi", expectedCity: "deutschland", expectedIntent: "rechner", priority: "P0" },
  { path: "/umzug-kosten-rechner", expectedStatus: 200, expectedH1Contains: ["Umzug", "Aufwand", "Rechner"], mustHaveCanonical: true, mustHaveMetaDescription: true, mustHaveCta: true, mustHaveContactLink: true, mustHaveNoFakeClaims: true, mustNotHaveNoindex: true, expectedService: "umzug", expectedCity: "deutschland", expectedIntent: "umzug-rechner", priority: "P0" },
  { path: "/reinigung-preis-rechner", expectedStatus: 200, expectedH1Contains: ["Reinigung", "Aufwand", "Rechner"], mustHaveCanonical: true, mustHaveMetaDescription: true, mustHaveCta: true, mustHaveContactLink: true, mustHaveNoFakeClaims: true, mustNotHaveNoindex: true, expectedService: "reinigung", expectedCity: "deutschland", expectedIntent: "reinigung-rechner", priority: "P0" },
  { path: "/duesseldorf/reinigung/anfrage", expectedStatus: 200, expectedH1Contains: ["Reinigung", "Düsseldorf", "Anfrage"], mustHaveCanonical: true, mustHaveMetaDescription: true, mustHaveCta: false, mustHaveContactLink: false, mustHaveNoFakeClaims: true, mustNotHaveNoindex: false, expectedNoindex: true, expectedCanonicalPath: "/duesseldorf/reinigung", excludeFromSitemap: true, expectedService: "reinigung", expectedCity: "duesseldorf", expectedIntent: "reinigung-duesseldorf-ads", priority: "P1", adsPage: true },
  { path: "/umzug-regensburg/anfrage", expectedStatus: 200, expectedH1Contains: ["Umzug", "Regensburg", "Anfrage"], mustHaveCanonical: true, mustHaveMetaDescription: true, mustHaveCta: false, mustHaveContactLink: false, mustHaveNoFakeClaims: true, mustNotHaveNoindex: false, expectedNoindex: true, expectedCanonicalPath: "/regensburg/umzug", excludeFromSitemap: true, expectedService: "umzug", expectedCity: "regensburg", expectedIntent: "umzug-regensburg-ads", priority: "P1", adsPage: true },
  { path: "/dashboard/login", expectedStatus: 200, expectedH1Contains: ["Anmelden", "Login", "Dashboard"], mustHaveCanonical: false, mustHaveMetaDescription: false, mustHaveCta: false, mustHaveContactLink: false, mustHaveNoFakeClaims: true, mustNotHaveNoindex: false, expectedNoindex: true, expectedService: "dashboard", expectedCity: "deutschland", expectedIntent: "dashboard-login", priority: "P1" },
...
function isNegatedClaim(normalizedText, index) {
  ...
  const neitherNor = /\bweder\b[^.!?]{0,100}\bnoch(?:\s+(?:ein|eine|einen|einem|einer|eines))?\s*$/.test(before);
  const directQuestionDenial = /\b(frage|ist|sind|wird|werden|kann|darf|ersetzt|bietet|gibt|leistet|uebernimmt|ubernimmt)\b[^.!?]{0,100}$/.test(before) &&
    /^[^.!?]{0,80}\?\s*nein\b/.test(after);
  return negatedBefore || neitherNor || directQuestionDenial;
}
