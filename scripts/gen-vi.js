...
// ===== VIETNAMESE =====
gen('vi', { title: "Khu vực dịch vụ", hub_note: "Trụ sở chính FLOXANT tại Regensburg. Trung tâm vận hành tại Regensburg và Oberpfalz. Chúng tôi phục vụ khắp Bavaria và cung cấp dịch vụ chuyển nhà đường dài trên toàn nước Đức.", description: "Trụ sở tại Regensburg. Trung tâm vận hành tại Regensburg.", cities: { regensburg: "Regensburg", bavaria: "Bavaria", munich: "München", nuremberg: "Nürnberg", augsburg: "Augsburg", germany: "Toàn nước Đức" } },
    apply({
        ...
        tt: "Minh bạch về trụ sở", tx: "Trụ sở pháp lý của FLOXANT tại Regensburg. Đội ngũ của chúng tôi thường xuyên làm việc tại München.", pt: "Danh mục dịch vụ cho München", cm: "Chuyển nhà nội thành München", cd: "Nhanh chóng và hiệu quả.", rm: "Chuyển nhà đường dài", rd: "Từ Isar đến Rhein.", cl: "Dọn dẹp", cld: "Xử lý chuyên nghiệp đồ cũ.", dt: "Đặc điểm München", dtx: "Mỗi thành phố có đặc thù riêng.", lt: "Từ Bavaria đến toàn Đức", ltx: "Nhiều khách hàng chuyển từ München đi.", prt: "Giá minh bạch không bất ngờ", prx: "München đã đủ đắt. Chúng tôi cam kết minh bạch tuyệt đối.", fi: "Khảo sát miễn phí: đánh giá trước qua video.", fis: "Bảo hiểm bao gồm: nội thất được bảo vệ toàn diện.", fs: "Nhân viên chuyên nghiệp: giàu kinh nghiệm và cẩn thận.", ln: "Địa điểm khác", mct: "Báo giá cho München", mcx: "Bắt đầu yêu cầu ngay.",
