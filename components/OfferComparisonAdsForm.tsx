...
const serviceOptions = [
  ...
  { value: "moebeltransport", label: "Möbeltransport / Furniture transport" },
  ...
  { value: "angebotscheck", label: "Angebotscheck / Second opinion" },
  { value: "objektbrief", label: "Objektbrief für bessere Anbieteranfrage" },
  { value: "uebergabeakte", label: "Übergabeakte für eine klare Dokumentation" },
  { value: "plan_b", label: "Plan B bei Ausfall oder Zeitdruck" },
