    ...
    <section className="px-4 py-12 sm:px-6" data-component="BusinessTrustPanel">
      <div className="mx-auto max-w-7xl rounded-lg border border-cyan-200 bg-cyan-50 p-6 md:p-8">
        <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            <div className="text-xs font-black uppercase tracking-normal text-cyan-900">Vertrauen fuer Unternehmen</div>
            <h2 className="mt-3 text-3xl font-black tracking-normal text-slate-950">
              Gewerbekunden brauchen klare Grenzen und gute Rueckfragen.
            </h2>
          </div>
