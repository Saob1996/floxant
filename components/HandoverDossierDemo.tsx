...
const dossierTabs = [
  {
    ...
    text: "Objektart, Zeitraum, Nebenräume und Zugang werden als organisatorischer Rahmen festgehalten.",
    items: ["Wohnung", "3 Räume", "Keller nach Absprache", "Zugangshinweis fürs Team"],
    Icon: ClipboardList,
  },
  {
    id: "services",
    ...
    items: ["Endreinigung", "Keller geräumt", "Entsorgung normaler Gegenstände", "Übergabevorbereitung"],
    Icon: FileCheck2,
  },
  {
    id: "photos",
    ...
    text: "Fotos können sichtbare Punkte einordnen. Es werden keine echten Kundendaten und keine Fake-Bilder gezeigt.",
    items: ["Küche", "Bad", "Böden", "Keller", "Zugang"],
    Icon: Camera,
  },
  {
    id: "keys",
    ...
    text: "Der Status wird organisatorisch festgehalten, sofern Schlüsselkoordination Teil der Absprache ist.",
    items: ["Schlüssel übernommen", "Empfänger: Hausverwaltung", "Termin geplant", "Rückfrage offen"],
    Icon: KeyRound,
  },
  {
    id: "notes",
    ...
    text: "Sichtbare Hinweise und offene Punkte werden getrennt von Teamnotizen geführt.",
    items: ["Balkon prüfen", "Müllraum nicht Teil des Auftrags", "Empfänger noch offen"],
    Icon: ShieldAlert,
  },
] as const;
...
export function HandoverDossierDemo() {
  ...
  return (
    <section id="uebergabeakte-demo" className="px-4 py-12 sm:px-6">
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] border border-slate-200 bg-slate-950 shadow-2xl shadow-slate-950/10">
        <div className="grid gap-0 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="bg-[radial-gradient(circle_at_top_left,rgba(251,191,36,0.26),transparent_22rem)] p-6 text-white sm:p-8">
            ...
            <h2 className="mt-5 text-3xl font-black tracking-tight sm:text-4xl">Interaktive Beispielakte: FLOXANT Übergabeakte</h2>
            <p className="mt-4 max-w-xl text-sm leading-7 text-slate-300">
              Diese Vorschau zeigt nur Demo-Inhalte. Umfang, Fotos, Schlüsselstatus und Hinweise hängen immer vom Auftrag und der Vereinbarung ab.
            </p>
          ...
          <div className="bg-white p-5 sm:p-8">
            <div className="rounded-[1.75rem] border border-amber-100 bg-amber-50/70 p-5">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.16em] text-amber-700">FLOXANT Übergabeakte · Beispielansicht</p>
              ...
              <div className="mt-5 rounded-2xl border border-slate-200 bg-white p-4">
                ...
                <p className="mt-2 text-sm leading-7 text-slate-700">
                  Organisatorische Dokumentation. Keine rechtliche Abnahme. Keine Garantie für Vermieterentscheidung, Kaution oder offizielle Wohnungsübergabe.
                </p>
              </div>
            </div>
          </div>
