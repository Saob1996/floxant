    ...
    <section className="px-4 py-12 sm:px-6" data-component="OfferConcernSelector">
      <div className="mx-auto max-w-7xl">
        <div className="mb-7 max-w-3xl">
          <div className="text-xs font-black uppercase tracking-normal text-blue-700">Pruefgrund</div>
          <h2 className="mt-3 text-3xl font-black tracking-normal text-slate-950">
            Was macht das Angebot unsicher?
          </h2>
          <p className="mt-3 text-base leading-8 text-slate-700">
            Die Auswahl fuehrt zum Kontaktformular mit passendem Intent. Es wird nichts abgesendet, bis das Formular bewusst gesendet wird.
          </p>
        </div>
