  ...
  return (
    <main className="overflow-hidden bg-white pb-24 text-slate-950 md:pb-0">
      ...
      <ServiceVisualProofGrid
        serviceKey={proofServiceKey}
        locationKey={config.cityKey}
        title={`Visuelle Orientierung für ${config.serviceName} in ${config.cityName}`}
        intro="Die Darstellungen bleiben neutral. Echte Fotos veröffentlichen wir nur mit Einwilligung und ohne private Daten."
      />
