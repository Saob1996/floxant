...
export function ServiceVisualProofGrid({
  ...
  intro = "Die sichtbaren Proof-Visuals sind abstrakt oder neutral. Echte Fotos brauchen Privacy-Check, Freigabe und duerfen keine Personen, Kennzeichen oder privaten Dokumente zeigen.",
  className = "",
