...
export function ServiceVisualProofGrid({
  ...
  intro = "Die Beispiele sind abstrakt oder neutral. Echte Fotos werden nur mit Freigabe gezeigt und dürfen keine Personen, Kennzeichen oder privaten Dokumente enthalten.",
  className = "",
    ...
    <section className={`bg-slate-50 px-5 py-14 text-slate-950 sm:px-8 lg:px-10 ${className}`} data-component="ServiceVisualProofGrid">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 max-w-3xl">
          <p className="text-sm font-black uppercase tracking-normal text-blue-700">Leistung anschaulich erklärt</p>
