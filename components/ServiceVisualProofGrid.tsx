...
export function ServiceVisualProofGrid({
  ...
  intro = "Die sichtbaren Darstellungen sind neutral. Echte Fotos veröffentlichen wir nur mit Freigabe und ohne Personen, Kennzeichen oder private Dokumente.",
  className = "",
    ...
    <section className={`bg-slate-50 px-5 py-14 text-slate-950 sm:px-8 lg:px-10 ${className}`} data-component="ServiceVisualProofGrid">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 max-w-3xl">
          <p className="text-sm font-black uppercase tracking-normal text-blue-700">Visuelle Orientierung</p>
