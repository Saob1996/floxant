  ...
  return (
    <aside className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm shadow-slate-950/5" data-component="OfferCheckTrustWithoutGuarantee">
      ...
      <p className="mt-2 text-sm leading-7 text-slate-700">
        FLOXANT prueft sachlich, ob Umfang, Aufwand und naechster Schritt nachvollziehbar sind. Es gibt keine Rechtsberatung, keine Preisgarantie und keine Zusage, dass jedes Angebot guenstiger wird.
      </p>
    </aside>
  );
}
