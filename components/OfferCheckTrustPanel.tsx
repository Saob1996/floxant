...
export function OfferCheckTrustPanel({ className = "" }: { className?: string }) {
  const trustItems = germanizeDeep([
    ...
    "Rückfragen nennen, wenn Angebot oder Fotos fehlen.",
    "Keine Bewertung fremder Anbieter als Claim.",
    "Plan B nur nach Ort, Termin und Machbarkeit prüfen.",
  ] as const);
      ...
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.85fr_1.15fr]">
        <div>
          ...
          <p className="mt-4 text-base font-semibold leading-8 text-slate-700">
            FLOXANT kann Umfang, Preisannahmen, offene Punkte und nächste Rückfragen praktisch einordnen. Das ist keine Rechtsberatung und keine Garantie auf einen niedrigeren Preis.
          </p>
        </div>
