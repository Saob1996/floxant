...
export function SignatureServicesGrid({
  ...
  intro = "Diese Services helfen, wenn ein Fall erst sortiert werden muss: Angebot, Objekt, Uebergabe, Plan B, Rueckfahrt, PV oder diskrete Abstimmung.",
    ...
    <section className={`bg-slate-950 px-5 py-14 text-white sm:px-8 lg:px-10 ${className}`}>
      <div className="mx-auto max-w-7xl">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-base font-semibold leading-8 text-slate-300">{intro}</p>
        </div>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {visibleServices.map((service) => (
            ...
            >
              ...
              <h3 className="mt-4 text-xl font-black tracking-normal text-white">{service.title}</h3>
