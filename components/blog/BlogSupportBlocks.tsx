...
function getLocalLinks(signal: string): RelatedLink[] {
  ...
  if (!links.length) {
    links.push(
      { href: "/kontakt?mode=neutral&source=website", title: "Kontakt", text: "Anfrage mit Ort, Termin und Fotos starten." },
...
export function BlogQuickAnswer({
  ...
  const primaryCta = ctas[0] || { href: "/kontakt?mode=neutral&source=website", label: "Anfrage starten" };
