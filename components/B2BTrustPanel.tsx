      ...
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.82fr_1.18fr]">
        <div>
          ...
          <h2 className="mt-3 text-3xl font-black tracking-normal sm:text-5xl">
            Klare Angaben für eine passende Reinigungsanfrage.
          </h2>
          <p className="mt-4 text-base font-semibold leading-8 text-slate-700">
            Nennen Sie Fläche, Turnus, Zeitfenster, Ansprechpartner, Zugang und besondere Anforderungen. So lassen sich offene Punkte gezielt klären.
          </p>
        </div>
        <div className="grid gap-3 md:grid-cols-2">
          {["Fläche und Raumliste", "Turnus und Reinigungszeiten", "Ansprechpartner und Zugang", "Nur nachvollziehbare Angaben"].map((item) => (
