    ...
    "@graph": [
      {
        ...
        description:
          "FLOXANT bietet Reinigung in Düsseldorf sowie Umzug, Entrümpelung, Wohnungsauflösung und Transport in Regensburg. Anfragen werden anhand der genannten Eckdaten geprüft.",
        knowsAbout: [
          "Umzug",
          "Reinigung",
      ...
      serviceGraphDatasetJsonLd,
      {
        ...
        hasPart: [
          ...
          { "@type": "WebPage", name: "Grundreinigung Düsseldorf", url: `${company.url}/duesseldorf/grundreinigung` },
          { "@type": "WebPage", name: "Unterhaltsreinigung Düsseldorf", url: `${company.url}/duesseldorf/unterhaltsreinigung` },
          { "@type": "WebPage", name: "Bauendreinigung Düsseldorf", url: `${company.url}/duesseldorf/baureinigung` },
