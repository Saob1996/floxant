...
export const inquiryConfigs: Record<InquiryIntent, InquiryConfig> = {
  ...
  cleaning: {
    ...
    regionScope: "Düsseldorf: Reinigung zuerst. Regensburg/Bayern: Reinigung nach Einsatzgebiet und Verfügbarkeit.",
  ...
  "offer-check": {
    ...
    regionScope: "Für vorhandene Angebote anderer Firmen. Düsseldorf bleibt auf Reinigung begrenzt.",
