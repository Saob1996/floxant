...
export const inquiryConfigs: Record<InquiryIntent, InquiryConfig> = {
  ...
  cleaning: {
    ...
    regionScope: "Düsseldorf: Reinigung über eigene lokale Einstiege. Regensburg/Bayern: Reinigung nach Einsatzgebiet und Verfügbarkeit.",
  ...
  "offer-check": {
    ...
    regionScope: "Für vorhandene Angebote anderer Firmen. Düsseldorf wird je nach Leistung über eigene lokale Seiten geprüft.",
