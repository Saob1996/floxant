...
export function ServiceAreaBlock({
  ...
  intro = "Für Reinigungsservices konzentriert sich FLOXANT auf Regensburg und den Umkreis bis 75 km. Orte außerhalb dieses Radius werden nicht als eigene Reinigungsziele beworben.",
