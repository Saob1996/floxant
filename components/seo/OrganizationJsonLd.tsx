...
export function OrganizationJsonLd() {
  const jsonLd = {
    ...
    keywords:
      "Umzug Regensburg, Reinigung Regensburg, Entrümpelung Regensburg, Umzug im 200-km-Umkreis Regensburg, Schlüsselübergabe, Übergabeprotokoll, Angebot anderer Firma prüfen, B2B-Reinigung Düsseldorf, Hotelreinigung Düsseldorf, Reinigung Neuss, Reinigung Ratingen, Angebot prüfen Düsseldorf, FLOXANT Bayern",
    knowsLanguage: ["de"],
    potentialAction: [
      {
        "@type": "ContactAction",
