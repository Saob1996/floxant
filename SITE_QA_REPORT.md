...
| PASS | Routing | app/duesseldorf/bueroreinigung/page.tsx | /duesseldorf/bueroreinigung | P1 | Kritische Route existiert als Page. | Keine Aktion. | no | no |
...
| PASS | Kontaktparameter | - | /duesseldorf/bueroreinigung | P1 | Kontaktziel ist PII-frei: /kontakt?service=bueroreinigung&city=duesseldorf&intent=office-cleaning-dusseldorf&source=seo. | Keine Aktion. | no | no |
| PASS | Kontaktparameter | - | /duesseldorf/grundreinigung | P1 | Kontaktziel ist PII-frei: /kontakt?service=grundreinigung&city=duesseldorf&intent=deep-cleaning-dusseldorf&source=seo. | Keine Aktion. | no | no |
...
| PASS | Lead-API | functions/_lib/lead-handler.js | /api/bookings | P0 | Cloudflare Lead-API verarbeitet Normalisierung, Datenschutz, Honeypot und Offer-Signale. | Keine Aktion. | no | no |
...
| /duesseldorf/grundreinigung | /kontakt?service=grundreinigung&city=duesseldorf&intent=deep-cleaning-dusseldorf&source=seo |
