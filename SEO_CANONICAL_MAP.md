...
- Kanonische Haupt-URL: /seniorenumzug-bayern
- Unterstützende URLs: siehe Varianten
- Duplicate-/Varianten-URLs: /de/seniorenumzug-bayern, /de/umzug-im-alter-bayern, /de/umzugshelfer-senioren-bayern, /de/seniorenumzug-erlangen, /de/seniorenumzug-bamberg
- Redirect-Kandidaten: klare Locale- und Legacy-Varianten mit gleichem Intent.
- Canonical-Kandidaten: nur Varianten mit separatem Suchintent behalten.
- Interne Link-Regel: Bayern-Hub intern stärken; Stadtvarianten nur bei eigener Substanz und GSC-Signal behalten.
- Sitemap-Regel: nur indexierbare kanonische URLs aufnehmen, keine `/de/`- oder `/fa/`-Duplicates.
