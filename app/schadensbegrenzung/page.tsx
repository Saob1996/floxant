    ...
    <>
      ...
      <main className="overflow-hidden bg-[radial-gradient(circle_at_top_left,#fecaca_0,transparent_34rem),linear-gradient(180deg,#fff1f2_0%,#ffffff_42%,#f8fafc_100%)] text-slate-950" data-event="view_damage_control">
        ...
        <div className="fixed inset-x-3 bottom-3 z-40 grid grid-cols-3 gap-2 rounded-[1.25rem] border border-slate-200 bg-white/95 p-2 shadow-2xl shadow-slate-950/20 backdrop-blur md:hidden">
          <a href={whatsappHref} className="rounded-xl bg-emerald-600 px-3 py-3 text-center text-xs font-black text-white" data-event="click_damage_whatsapp">
            WhatsApp
          </a>
          <Link href="#schadensbegrenzung-form" className="rounded-xl bg-slate-950 px-3 py-3 text-center text-xs font-black text-white" data-event="start_damage_control_lead">
            Problem senden
          </Link>
          <a href="tel:+4915771105087" className="rounded-xl bg-red-600 px-3 py-3 text-center text-xs font-black text-white" data-event="click_damage_phone">
            Anrufen
          </a>
        </div>
      </main>
