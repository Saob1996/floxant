...
import { Paintbrush, Shield, Clock, Star, Zap, House } from "lucide-react";
interface PageProps {
    params: Promise<{}>;
}
...
export default async function MalerarbeitenPage({ params }: PageProps) {
    ...
    return (
        <SpecialtyPageLayout
                ...
                chips={[
                    { icon: Paintbrush, text: resolveNestedField(content.badges, fallback.badges, "permit", city) },
