...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    return generatePageSEO({
        lang: "de",
        path: "klaviertransport-saal-an-der-donau",
...
export default async function KlaviertransportSaalAnDerDonauPage({ params }: PageProps) {
    const locale = "de";
    const { 
        localeDict, 
        content, 
    ...
    return (
        <SpecialtyPageLayout
                ...
                breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Klaviertransport","href":"/klaviertransport"},{"label":"Saal an der Donau"}]}
                chips={[
