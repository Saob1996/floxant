...
const combinations = [
  ...
  { href: "/objektbrief", title: "Mit Objektbrief", text: "Wenn Reinigung, Fotos, Schlüsselweg, Nachnutzung und offene Punkte für Vermieter oder Verwaltung gemeinsam sortiert werden sollen." },
  { href: "/plan-b-service", title: "Mit Plan-B-Service", text: "Wenn kurz vor Übergabe noch Frist, Zustand, Angebot, Restmengen und Dokumentationsbedarf geklärt werden müssen." },
