    ...
    <>
      ...
      <main className="overflow-hidden bg-[radial-gradient(circle_at_top_left,#fde68a_0,transparent_30rem),linear-gradient(180deg,#fff7ed_0%,#ffffff_44%,#f8fafc_100%)] text-slate-950" data-event="view_handover_dossier">
        ...
        <div className="fixed inset-x-3 bottom-3 z-40 grid grid-cols-3 gap-2 rounded-[1.25rem] border border-slate-200 bg-white/95 p-2 shadow-2xl shadow-slate-950/20 backdrop-blur md:hidden">
          <Link href="#uebergabeakte-form" className="rounded-xl bg-slate-950 px-3 py-3 text-center text-xs font-black text-white" data-event="start_handover_file_lead">
            Akte
          </Link>
          <a href={whatsappHref} className="rounded-xl bg-emerald-50 px-3 py-3 text-center text-xs font-black text-emerald-800" data-event="click_handover_whatsapp">
            WhatsApp
          </a>
          <a href={`tel:${company.phoneRaw}`} className="rounded-xl bg-amber-50 px-3 py-3 text-center text-xs font-black text-amber-900" data-event="click_handover_phone">
            Anrufen
          </a>
        </div>
      </main>
