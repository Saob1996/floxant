...
export default async function SeniorenumzugIngolstadtPage({ params }: PageProps) {
    const locale = "de";
    const { 
        localeDict, 
        content, 
    ...
    return (
        <SpecialtyPageLayout
            pagePath="/seniorenumzug-ingolstadt"
                lang="de"
                dict={localeDict}
                city={city}
                ...
                breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Seniorenumzug","href":"/seniorenumzug"},{"label":"Ingolstadt"}]}
                chips={[
