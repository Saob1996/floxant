...
export default async function KlaviertransportFürthPage({ params }: PageProps) {
    const locale = "de";
    const { 
        localeDict, 
        content, 
    ...
    return (
        <SpecialtyPageLayout
                ...
                breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Klaviertransport","href":"/klaviertransport"},{"label":"Fürth"}]}
                chips={[
