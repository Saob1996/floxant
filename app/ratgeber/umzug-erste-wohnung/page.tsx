...
return generatePageSEO({
    ...
    description: "Den Umzug in die erste Wohnung planen: Budget für Kaution, Einrichtung und Transport ordnen, Grundausstattung auswählen und einen kleinen Umzug vorbereiten.",
  });
}
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">FLOXANT übernimmt kleine Umzüge in Regensburg und im örtlichen 75-km-Gebiet. Fernumzüge mit Start oder Ziel in Regensburg stimmen wir nach Strecke und Termin ab. Wenige Möbel bedeuten oft weniger Volumen, aber nicht automatisch weniger Aufwand bei Treppenhaus, Parken oder Übergabe.</p>
          </div>
          <div>
