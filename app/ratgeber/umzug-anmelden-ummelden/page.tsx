...
return generatePageSEO({
    ...
    title: "Umzug anmelden und ummelden: Die wichtigsten Schritte | FLOXANT",
...
export default async function Article() {
  ...
  return (
    <main className="min-h-screen bg-background">
      <Breadcrumbs lang="de" items={[{ label: "Ratgeber", href: `/ratgeber` }, { label: "Umzug anmelden & ummelden" }]} />
