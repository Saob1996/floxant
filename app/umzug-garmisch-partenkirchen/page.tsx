...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    return generatePageSEO({
        lang: "de",
        path: "umzug-garmisch-partenkirchen",
...
export default async function UmzugGarmischPartenkirchenPage({ params }: PageProps) {
    ...
    return (
        <SpecialtyPageLayout
            ...
            breadcrumbs={[{ label: "Home", href: "/" }, { label: "Umzug", href: "/umzug" }, { label: "Garmisch-Partenkirchen" }]}
            chips={[
