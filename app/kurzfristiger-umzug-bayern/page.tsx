    ...
    <main className="min-h-screen bg-background text-start font-sans">
      ...
      <section className="pt-8 pb-20 px-6 bg-gradient-to-b from-muted/20 to-background">
        <div className="max-w-7xl mx-auto text-center space-y-8">
          ...
          <Link href="/kontakt?service=umzug&intent=kurzfristiger-umzug" className="inline-flex min-h-12 items-center justify-center rounded-lg bg-slate-950 px-6 font-black text-white">
