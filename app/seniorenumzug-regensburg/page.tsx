...
export default async function SeniorenumzugRegensburgPage({ params }: PageProps) {
    const locale = "de";
    const { 
        localeDict, 
        content, 
    ...
    return (
        <SpecialtyPageLayout
                ...
                breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Seniorenumzug","href":"/seniorenumzug"},{"label":"Regensburg"}]}
                chips={[
            ...
            >
                <LocalSeniorMoveSupport city="Regensburg" route="regensburg" />
