...
export default async function SeniorenumzugLandshutPage({ params }: PageProps) {
    const locale = "de";
    const { 
        localeDict, 
        content, 
    ...
    return (
        <SpecialtyPageLayout
            pagePath="/seniorenumzug-landshut"
                lang="de"
                dict={localeDict}
                city={city}
                ...
                breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Seniorenumzug","href":"/seniorenumzug"},{"label":"Landshut"}]}
                chips={[
            ...
            >
                <LocalSeniorMoveSupport city="Landshut" route="landshut" />
