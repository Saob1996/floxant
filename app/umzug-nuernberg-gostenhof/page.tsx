...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    return generatePageSEO({
        lang: "de",
        path: "umzug-nuernberg-gostenhof",
...
export default async function UmzugNuernbergGostenhofPage({ params }: PageProps) {
    ...
    return (
        <SpecialtyPageLayout
            ...
            breadcrumbs={[{ label: "Home", href: "/" }, { label: "Umzug", href: "/umzug" }, { label: "Nürnberg Gostenhof" }]}
            chips={[
