...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return generatePageSEO({
    lang: "de",
    path: "umzug-muenchen-bogenhausen",
...
export default async function UmzugMuenchenBogenhausenPage({ params }: PageProps) {
  ...
  return (
    <SpecialtyPageLayout
      ...
      breadcrumbs={[{ label: "Home", href: "/" }, { label: "Umzug", href: "/umzug" }, { label: "München Bogenhausen" }]}
      chips={[
