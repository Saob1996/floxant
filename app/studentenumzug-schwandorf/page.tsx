...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return generatePageSEO({
    lang: "de",
    path: "studentenumzug-schwandorf",
...
export default async function StudentenumzugSchwandorfPage({ params }: PageProps) {
  const locale = "de";
  const { 
    localeDict, 
    content, 
  ...
  return (
    <SpecialtyPageLayout
        ...
        breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Studentenumzug","href":"/studentenumzug-bayern"},{"label":"Schwandorf"}]}
        chips={[
