    ...
    <>
      ...
      <main className="overflow-hidden bg-[radial-gradient(circle_at_16%_2%,#f5f5f4_0,transparent_30rem),radial-gradient(circle_at_86%_0%,#e7e5e4_0,transparent_28rem),linear-gradient(180deg,#fafaf9_0%,#ffffff_46%,#f5f5f4_100%)] text-stone-950" data-event="view_estate_clearance">
        ...
        <div className="fixed inset-x-3 bottom-3 z-40 grid grid-cols-3 gap-2 rounded-2xl border border-stone-200 bg-white/95 p-2 shadow-2xl shadow-stone-950/20 backdrop-blur md:hidden">
          <Link href="#nachlass-form" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-stone-950 px-4 text-xs font-black text-white" data-event="start_estate_clearance_lead">
            Diskret anfragen
          </Link>
          <a href={whatsappHref} className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-emerald-200 bg-emerald-50 px-4 text-xs font-black text-emerald-800" data-event="click_estate_whatsapp">
            WhatsApp
          </a>
          <a href={phoneHref} className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-stone-200 bg-stone-50 px-4 text-xs font-black text-stone-800" data-event="click_estate_phone">
            Rueckruf
          </a>
        </div>
      </main>
