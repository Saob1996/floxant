...
export default async function SeniorenumzugTraunsteinPage({ params }: PageProps) {
  const locale = "de";
  const { 
    localeDict, 
    content, 
  ...
  return (
    <SpecialtyPageLayout
        ...
        breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Seniorenumzug","href":"/seniorenumzug"},{"label":"Traunstein"}]}
        chips={[
