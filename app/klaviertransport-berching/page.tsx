...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    return generatePageSEO({
        lang: "de",
        path: "klaviertransport-berching",
...
export default async function KlaviertransportBerchingPage({ params }: PageProps) {
    const locale = "de";
    const { 
        localeDict, 
        content, 
    ...
    return (
        <SpecialtyPageLayout
                ...
                breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Klaviertransport","href":"/klaviertransport"},{"label":"Berching"}]}
                chips={[
