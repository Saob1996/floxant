...
export default async function BueroumzugBernhardswaldPage({ params }: PageProps) {
  const locale = "de";
  const { 
    localeDict, 
    content, 
  ...
  return (
    <SpecialtyPageLayout
        ...
        breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Büroumzug","href":"/bueroumzug"},{"label":"Bernhardswald"}]}
        chips={[
