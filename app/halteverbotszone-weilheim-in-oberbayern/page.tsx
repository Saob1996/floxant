...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return generatePageSEO({
    lang: "de",
    path: "halteverbotszone-weilheim-in-oberbayern",
...
export default async function HalteverbotszoneWeilheimInOberbayernPage({ params }: PageProps) {
  const locale = "de";
  const { 
    localeDict, 
    content, 
  ...
  return (
    <SpecialtyPageLayout
        ...
        breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Halteverbotszone","href":"/halteverbotszone-regensburg"},{"label":"Weilheim in Oberbayern"}]}
        chips={[
