...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const content = (dict?.pages as any)?.["sig_key_handover"] || {};
  return generatePageSEO({
    lang: "de",
    path: "schluesseluebergabe",
    title: content.meta_title || "Schlüsselübergabe | FLOXANT",
    description: content.meta_desc || "Schlüsselübergabe – Professioneller Service von FLOXANT in Bayern.",
  });
}

export default async function SchlüsselübergabePage() {
  const dict = await getDictionary("de");
  const content = (dict?.pages as any)?.["sig_key_handover"] || {};
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden section-glow">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-semibold tracking-tight text-white mb-6 leading-[1.05]">
            {content.hero_title || "Schlüsselübergabe"}
          </h1>
