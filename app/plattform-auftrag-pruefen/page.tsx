  ...
  return (
    <>
      ...
      <main className="overflow-hidden bg-[radial-gradient(circle_at_top_left,#e0f2fe_0,transparent_34rem),linear-gradient(180deg,#f8fafc_0%,#ffffff_44%,#f8fafc_100%)] text-slate-950" data-event="view_platform_order_page">
        ...
        <div className="fixed inset-x-3 bottom-3 z-40 grid grid-cols-3 gap-2 rounded-[1.25rem] border border-slate-200 bg-white/95 p-2 shadow-2xl shadow-slate-950/15 backdrop-blur md:hidden">
          <Link href="#plattform-form" className="rounded-xl bg-slate-950 px-3 py-3 text-center text-xs font-black text-white" data-event="start_platform_order_check">
            Angebot senden
          </Link>
          <a href={whatsappHref} className="rounded-xl bg-emerald-600 px-3 py-3 text-center text-xs font-black text-white" data-event="click_platform_order_whatsapp">
            WhatsApp
          </a>
          <a href="tel:+4915771105087" className="rounded-xl bg-blue-600 px-3 py-3 text-center text-xs font-black text-white" data-event="click_platform_order_phone">
            Anrufen
          </a>
        </div>
      </main>
