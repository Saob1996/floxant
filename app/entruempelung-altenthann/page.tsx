...
export default async function EntruempelungAltenthannPage({ params }: PageProps) {
  const locale = "de";
  const { 
    localeDict, 
    content, 
  ...
  return (
    <SpecialtyPageLayout
        ...
        breadcrumbs={[{"label":"Home","href":"/"},{"label":"Entrümpelung","href":"/entruempelung"},{"label":"Altenthann"}]}
        chips={[
