      ...
      <div className="mx-auto max-w-4xl px-6">
        ...
        <div className="mt-20 border-t border-white/10 pt-12">
          <div className="rounded-3xl bg-blue-600/10 p-10 text-center">
            ...
            <Link href="/kontakt?service=entruempelung&intent=entruempelung-bayern-leitfaden&source=blog" className="btn-premium inline-flex py-4 px-10 rounded-2xl bg-blue-600 font-bold uppercase tracking-widest">
