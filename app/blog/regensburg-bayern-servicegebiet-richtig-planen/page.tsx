...
const faqItems = [
 {
  ...
  a: "Regensburg ist der Ausgangspunkt. Reinigung bleibt auf Regensburg und 75 km Umkreis begrenzt; Umzug und Entrümpelung werden separat nach Machbarkeit eingeordnet.",
 },
 {
 ...
 const jsonLd = {
  ...
  "@graph": [
   buildWebPageJsonLd({
    ...
    path: "/blog/regensburg-bayern-servicegebiet-richtig-planen",
    about: ["Regensburg", "75 km Reinigung", "Umzug", "Entrümpelung", "Servicegebiet"],
   }),
   buildBreadcrumbJsonLd([
    { name: "FLOXANT", item: "/" },
    { name: "Blog", item: "/blog" },
    ...
    sections={[
     {
      ...
      paragraphs: [
       "Für Google ist die regionale Einordnung wichtig. Für Kunden ist sie noch wichtiger. Wer einen Umzug, eine Reinigung oder eine Entrümpelung plant, braucht keine leere Floskel, sondern die Frage: Ist der Einsatz realistisch planbar? Für Reinigung gilt dabei Regensburg plus 75 km.",
     ...
     },
     {
      ...
      paragraphs: [
       "Regensburg ist der natürliche Schwerpunkt für FLOXANT. Hier lassen sich viele Anfragen schneller prüfen, Wege besser einschätzen und Zusatzleistungen wie Reinigung im 75-km-Umkreis, Beiladung oder Entrümpelung enger koordinieren.",
      ],
      bullets: [
