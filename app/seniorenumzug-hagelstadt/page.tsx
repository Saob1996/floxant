...
export default async function SeniorenumzugHagelstadtPage({ params }: PageProps) {
    const locale = "de";
    const { 
        localeDict, 
        content, 
    ...
    return (
        <SpecialtyPageLayout
                ...
                breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Seniorenumzug","href":"/seniorenumzug"},{"label":"Hagelstadt"}]}
                chips={[
