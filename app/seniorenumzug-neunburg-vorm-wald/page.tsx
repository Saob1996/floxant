...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return generatePageSEO({
    lang: "de",
    path: "seniorenumzug-neunburg-vorm-wald",
...
export default async function SeniorenumzugNeunburgVormWaldPage({ params }: PageProps) {
  const locale = "de";
  const { 
    localeDict, 
    content, 
  ...
  return (
    <SpecialtyPageLayout
        ...
        breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Seniorenumzug","href":"/seniorenumzug"},{"label":"Neunburg vorm Wald"}]}
        chips={[
