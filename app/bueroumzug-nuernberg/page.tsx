...
export default async function BueroumzugNuernbergPage({ params }: PageProps) {
    const locale = "de";
    const { 
        localeDict, 
        content, 
    ...
    return (
        <SpecialtyPageLayout
                ...
                breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Büroumzug","href":"/bueroumzug"},{"label":"Nürnberg"}]}
                chips={[
            ...
            >
                <LocalSeoSearchIntentBridge
                    service="bueroumzug"
                    city={city}
                    currentHref="/bueroumzug-nuernberg"
                />
            </SpecialtyPageLayout>
    );
}
