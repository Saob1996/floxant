...
export default async function StudentenumzugNabburgPage({ params }: PageProps) {
  const locale = "de";
  const { 
    localeDict, 
    content, 
  ...
  return (
    <SpecialtyPageLayout
        ...
        breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Studentenumzug","href":"/studentenumzug-bayern"},{"label":"Nabburg"}]}
        chips={[
