...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return generatePageSEO({
    lang: "de",
    path: "wohnungsaufloesung-neunburg-vorm-wald",
...
export default async function WohnungsaufloesungNeunburgVormWaldPage({ params }: PageProps) {
  const locale = "de";
  const { 
    localeDict, 
    content, 
  ...
  return (
    <SpecialtyPageLayout
        ...
        breadcrumbs={[{"label":"Home","href":"/"},{"label":"Entrümpelung","href":"/entruempelung"},{"label":"Wohnungsauflösung","href":"/wohnungsaufloesung-bayern"},{"label":"Neunburg vorm Wald"}]}
        chips={[
