...
export default async function HalteverbotszoneChamPage({ params }: PageProps) {
  const locale = "de";
  const { 
    localeDict, 
    content, 
  ...
  return (
    <SpecialtyPageLayout
        ...
        breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Halteverbotszone","href":"/halteverbotszone-regensburg"},{"label":"Cham"}]}
        chips={[
