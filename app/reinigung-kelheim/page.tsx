...
export default async function ReinigungKelheimPage({ params }: PageProps) {
    const locale = "de";
    const { 
        localeDict, 
        content, 
