...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    return generatePageSEO({
        lang: "de",
        path: "reinigung-windischeschenbach",
...
export default async function ReinigungWindischeschenbachPage({ params }: PageProps) {
    const locale = "de";
    const { 
        localeDict, 
        content, 
    ...
    return (
        <SpecialtyPageLayout
                ...
                breadcrumbs={[{"label":"Home","href":"/"},{"label":"Reinigung","href":"/reinigung"},{"label":"Windischeschenbach"}]}
                chips={[
