...
const CITY_KEY = "nuernberg-ziegelstein";
const DISPLAY_NAME = "Nürnberg Ziegelstein";
...
export default async function UmzugNuernbergZiegelsteinPage() {
  const { localeDict, content, fallback, city, neighborhoods } = await getSpecialtyPageData({
    locale: "de",
    baseKey: "umzug_spec",
    city: DISPLAY_NAME,
    seoKey: CITY_KEY,
  ...
  return (
    <SpecialtyPageLayout
      ...
      breadcrumbs={[
        { label: "Home", href: "/" },
        { label: "Umzug Nürnberg", href: "/umzug-nuernberg" },
        { label: city },
      ]}
      chips={[
