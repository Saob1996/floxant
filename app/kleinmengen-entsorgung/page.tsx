      ...
      <section id="booking" className="bg-slate-900/50 py-24">
        <div className="mx-auto max-w-5xl px-6">
          <div className="mb-12 text-center">
            ...
            <Link href="/kontakt?service=kleinmengen-entsorgung&intent=abholung-pruefen" className="mt-6 inline-flex min-h-12 items-center justify-center rounded-lg bg-white px-6 font-black text-slate-950">
