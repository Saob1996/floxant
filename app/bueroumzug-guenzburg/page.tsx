...
export default async function BueroumzugGuenzburgPage({ params }: PageProps) {
  const locale = "de";
  const { 
    localeDict, 
    content, 
  ...
  return (
    <SpecialtyPageLayout
        ...
        breadcrumbs={[{"label":"Home","href":"/"},{"label":"Umzug","href":"/umzug"},{"label":"Büroumzug","href":"/bueroumzug"},{"label":"Günzburg"}]}
        chips={[
