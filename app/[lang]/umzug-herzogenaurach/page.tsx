        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-herzogenaurach` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Höchstadt", href: "/de/umzug-hoechstadt-an-der-aisch" },
                                { name: "Aurachtal", href: "/de/umzug-aurachtal" },
                                { name: "Großenseebach", href: "/de/umzug-grossenseebach" },
                                { name: "Heßdorf", href: "/de/umzug-hessdorf" },
                                { name: "Weisendorf", href: "/de/umzug-weisendorf" },
                                { name: "Oberreichenbach", href: "/de/umzug-oberreichenbach" },
                                { name: "Münchaurach", href: "/de/umzug-muenchaurach" },
                                { name: "Emtmannsberg", href: "/de/umzug-emtmannsberg" },
