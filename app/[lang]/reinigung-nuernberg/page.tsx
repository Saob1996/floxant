...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({
        ...
        title: 'Professionelle Reinigung in Nürnberg | FLOXANT',
        description: 'Professionelle Professionelle Reinigung in Nürnberg in Bayern. Seriöse Abwicklung, Festpreisgarantie und versicherter Transport. Jetzt online berechnen!',
    });
}
...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const faqJsonLd = {
        ...
        "mainEntity": [
                { "@type": "Question", "name": content.faqs?.[0]?.q || "Was kostet eine Reinigung in Nürnberg?", "acceptedAnswer": { "@type": "Answer", "text": content.faqs?.[0]?.a || "3 bis 5 Euro pro Quadratmeter für eine professionelle Endreinigung. Festpreis nach Besichtigung." } },
    ...
    const localBusinessJsonLd = {
        ...
        "url": `https://www.floxant.de/${pageLocale}/reinigung-nuernberg`,
    ...
    const breadcrumbsJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Reinigung Nürnberg", "item": `https://www.floxant.de/${pageLocale}/reinigung-nuernberg` }
        ]
    };

    return (
        <main className="min-h-screen bg-background">
            <Breadcrumbs pageLocale={pageLocale} items={[{ label: "Reinigung Bayern", href: `/${pageLocale}/reinigung-bayern` }, { label: "Reinigung Nürnberg" }]} />
