...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({ lang, path: 'reinigung-augsburg', title: 'Reinigung Augsburg | Professionelle Endreinigung | FLOXANT', description: 'Professionelle Reinigung in Augsburg. Endreinigung für Wohnungsübergabe, Büroreinigung und Grundreinigung. Festpreis & Abnahmegarantie.' });
}
...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const faqJsonLd = {
        ...
        "mainEntity": [
            { "@type": "Question", "name": "Was kostet eine Reinigung in Augsburg?", "acceptedAnswer": { "@type": "Answer", "text": "3 bis 5 Euro pro Quadratmeter für eine professionelle Endreinigung. Festpreis nach Besichtigung." } },
    ...
    const localBusinessJsonLd = {
        ...
        "url": `https://www.floxant.de/${lang}/reinigung-augsburg`,
    ...
    const breadcrumbsJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Reinigung Augsburg", "item": `https://www.floxant.de/${lang}/reinigung-augsburg` }
        ]
    };
    ...
    return (
        <main className="min-h-screen bg-background">
            ...
            <Breadcrumbs lang={lang} items={[{ label: "Reinigung Bayern", href: `/${lang}/reinigung-bayern` }, { label: "Reinigung Augsburg" }]} />
