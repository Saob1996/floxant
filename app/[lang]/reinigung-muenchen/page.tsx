...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({ lang, path: 'reinigung-muenchen', title: 'Reinigung München | Professionelle Endreinigung | FLOXANT', description: 'Professionelle Reinigung in München. Endreinigung für Wohnungsübergabe, Büroreinigung und Grundreinigung. Festpreis & Abnahmegarantie.' });
}
...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const faqJsonLd = {
        ...
        "mainEntity": [
            { "@type": "Question", "name": "Was kostet eine Reinigung in München?", "acceptedAnswer": { "@type": "Answer", "text": "3 bis 5 Euro pro Quadratmeter für eine professionelle Endreinigung. Festpreis nach Besichtigung." } },
    ...
    const localBusinessJsonLd = {
        ...
        "name": "FLOXANT Reinigung München",
    ...
    const serviceJsonLd = {
        ...
        "provider": { "@type": "LocalBusiness", "name": "FLOXANT Reinigung München", "telephone": "+4915771105087" },
        "areaServed": { "@type": "City", "name": "München" }
    };
    ...
    const breadcrumbsJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Reinigung München", "item": `https://www.floxant.de/${lang}/reinigung-muenchen` }
        ]
    };
    ...
    return (
        <main className="min-h-screen bg-background">
            ...
            <Breadcrumbs lang={lang} items={[{ label: "Reinigung Bayern", href: `/${lang}/reinigung-bayern` }, { label: "Reinigung München" }]} />
            ...
            <section className="pt-8 pb-20 px-6 bg-gradient-to-b from-muted/20 to-background">
                <div className="max-w-7xl mx-auto text-center space-y-8">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-foreground">
                        Professionelle Reinigung in <span className="text-primary">München</span>
                    </h1>
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        FLOXANT bietet professionelle Reinigungsservices in München und Umgebung. Von der Endreinigung bei der Wohnungsübergabe bis zur Grundreinigung – wir garantieren ein Ergebnis, das jeden Vermieter überzeugt.
                    </p>
                </div>
            </section>
            ...
            <section className="py-20 px-6">
                <div className="max-w-4xl mx-auto space-y-16">
                    <div className="prose prose-lg max-w-none text-muted-foreground">
                        <h2 className="text-3xl font-bold text-foreground mb-6">Endreinigung in München</h2>
                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            {[
                            { q: "Was kostet eine Reinigung in München?", a: "3 bis 5 Euro pro Quadratmeter für eine professionelle Endreinigung. Festpreis nach Besichtigung." },
                    ...
                    <div className="text-center py-10 bg-gradient-to-br from-primary/5 via-transparent to-primary/5 rounded-3xl border border-primary/10 shadow-lg">
                        <h2 className="text-3xl font-bold mb-4">Reinigung in München anfragen</h2>
                        <p className="text-muted-foreground mb-8 max-w-xl mx-auto">Kostenloses Festpreisangebot für Reinigung in München.</p>
