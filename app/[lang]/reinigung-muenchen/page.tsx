...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const localBusinessJsonLd = {
        ...
        "url": `https://www.floxant.de/${pageLocale}/reinigung-muenchen`,
    ...
    const breadcrumbsJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Reinigung München", "item": `https://www.floxant.de/${pageLocale}/reinigung-muenchen` }
        ]
    };

    return (
        <main className="min-h-screen bg-background">
            <Breadcrumbs pageLocale={pageLocale} items={[{ label: "Reinigung Bayern", href: `/${pageLocale}/reinigung-bayern` }, { label: "Reinigung München" }]} />
