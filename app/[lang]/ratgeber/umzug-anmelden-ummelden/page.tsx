...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({ lang, path: 'ratgeber/umzug-anmelden-ummelden', title: 'Umzug anmelden & ummelden | FLOXANT Ratgeber', description: 'Alle Behördengänge beim Umzug: Anmeldung, Ummeldung, Fristen und Checkliste. Sofortpreis online berechnen oder bequem per WhatsApp / Telefon anfragen: +49 1577 1105087.' });
}
