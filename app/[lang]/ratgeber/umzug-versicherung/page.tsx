...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({ lang, path: 'ratgeber/umzug-versicherung', title: 'Umzug Versicherung: Was ist wichtig? | FLOXANT Ratgeber', description: 'Transportversicherung beim Umzug: Was deckt sie ab und worauf sollten Sie achten? Sofortpreis online berechnen oder bequem per WhatsApp / Telefon anfragen: +49 1577 1105087.' });
}
