...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({ lang, path: 'ratgeber/wohnungsaufloesung-tipps', title: 'Wohnungsauflösung: Tipps und Kosten | FLOXANT Ratgeber', description: 'Wohnungsauflösung organisieren: Ablauf, Kosten, Checkliste und Tipps von FLOXANT. Sofortpreis online berechnen oder bequem per WhatsApp / Telefon anfragen: +49 1577 1105087.' });
}
