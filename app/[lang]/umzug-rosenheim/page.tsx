...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_rosenheim",
        city: "Rosenheim",
    });

    return generatePageSEO({
        pageLocale: lang,
        path: `umzug-rosenheim`,
        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-rosenheim`,
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-rosenheim` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                ...
                <section className="bg-slate-50 py-16 px-6 border-t border-border">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                { name: "Rosenheim", href: "/de/umzug-rosenheim" },
                                { name: "Kolbermoor", href: "/de/umzug-kolbermoor" },
                                { name: "Bad Aibling", href: "/de/umzug-bad-aibling" },
                                { name: "Stephanskirchen", href: "/de/umzug-stephanskirchen" },
                                { name: "Raubling", href: "/de/umzug-raubling" },
                                { name: "Wasserburg am Inn", href: "/de/umzug-wasserburg-am-inn" },
                                { name: "Prien am Chiemsee", href: "/de/umzug-prien-am-chiemsee" },
                                { name: "Feldkirchen-Westerham", href: "/de/umzug-feldkirchen-westerham" },
                                { name: "Bruckmühl", href: "/de/umzug-bruckmuehl" },
                                { name: "Großkarolinenfeld", href: "/de/umzug-grosskarolinenfeld" },
                                { name: "Schechen", href: "/de/umzug-schechen" },
                                { name: "Rohrdorf", href: "/de/umzug-rohrdorf" },
