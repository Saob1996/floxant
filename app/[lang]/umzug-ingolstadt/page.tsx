        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-ingolstadt` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Eichstätt", href: "/de/umzug-eichstaett" },
                                { name: "Neuburg an der Donau", href: "/de/umzug-neuburg-an-der-donau" },
                                { name: "Pfaffenhofen", href: "/de/umzug-pfaffenhofen" },
                                { name: "Schrobenhausen", href: "/de/umzug-schrobenhausen" },
                                { name: "Manching", href: "/de/umzug-manching" },
                                { name: "Gaimersheim", href: "/de/umzug-gaimersheim" },
                                { name: "Kösching", href: "/de/umzug-koesching" },
                                { name: "Lenting", href: "/de/umzug-lenting" },
                                { name: "Geisenfeld", href: "/de/umzug-geisenfeld" },
                                { name: "Vohburg", href: "/de/umzug-vohburg" },
                                { name: "Karlshuld", href: "/de/umzug-karlshuld" },
