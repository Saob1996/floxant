...
export default async function UmzugPassau({ params }: { params: Promise<{ lang: string }> }) {
    ...
    return (
        <main className="min-h-screen bg-background">
            ...
            `FLOXANT ist Ihr starker Umzugspartner für Passau. Wir bieten {dict.calculator?.fixed_price_tag}, voll versicherten Transport und lokale Expertise für Privathaushalte und Firmen.`
          </p>
