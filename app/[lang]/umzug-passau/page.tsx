        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-passau` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Hauzenberg", href: "/de/umzug-hauzenberg" },
                                { name: "Bad Griesbach", href: "/de/umzug-bad-griesbach" },
                                { name: "Fürstenzell", href: "/de/umzug-fuerstenzell" },
                                { name: "Tiefenbach", href: "/de/umzug-tiefenbach" },
                                { name: "Salzweg", href: "/de/umzug-salzweg" },
                                { name: "Thyrnau", href: "/de/umzug-thyrnau" },
                                { name: "Büchlberg", href: "/de/umzug-buechlberg" },
