        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-pocking`,
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-pocking` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Pocking", href: "/de/umzug-pocking" },
                                { name: "Ruhstorf an der Rott", href: "/de/umzug-ruhstorf-an-der-rott" },
                                { name: "Bad Füssing", href: "/de/umzug-bad-fuessing" },
                                { name: "Kirchham", href: "/de/umzug-kirchham" },
                                { name: "Rotthalmünster", href: "/de/umzug-rotthalmuenster" },
                                { name: "Malching", href: "/de/umzug-malching" },
                                { name: "Tettenweis", href: "/de/umzug-tettenweis" },
                                { name: "Neuhaus am Inn", href: "/de/umzug-neuhaus-am-inn" },
                                { name: "Vilshofen", href: "/de/umzug-vilshofen" },
                                { name: "Bad Griesbach", href: "/de/umzug-bad-griesbach" },
                                { name: "Pfarrkirchen", href: "/de/umzug-pfarrkirchen" },
                                { name: "Simbach am Inn", href: "/de/umzug-simbach-am-inn" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
