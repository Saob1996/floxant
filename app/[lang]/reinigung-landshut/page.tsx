...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({ lang, path: 'reinigung-landshut', title: 'Reinigung Landshut | Professionelle Endreinigung | FLOXANT', description: 'Professionelle Reinigung in Landshut. Endreinigung für Wohnungsübergabe, Büroreinigung und Grundreinigung. Festpreis & Abnahmegarantie.' });
}
...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const faqJsonLd = {
        ...
        "mainEntity": [
            { "@type": "Question", "name": "Was kostet eine Reinigung in Landshut?", "acceptedAnswer": { "@type": "Answer", "text": "3 bis 5 Euro pro Quadratmeter für eine professionelle Endreinigung. Festpreis nach Besichtigung." } },
    ...
    const localBusinessJsonLd = {
        ...
        "url": `https://www.floxant.de/${lang}/reinigung-landshut`,
    ...
    const breadcrumbsJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Reinigung Landshut", "item": `https://www.floxant.de/${lang}/reinigung-landshut` }
        ]
    };
    ...
    return (
        <main className="min-h-screen bg-background">
            ...
            <Breadcrumbs lang={lang} items={[{ label: "Reinigung Bayern", href: `/${lang}/reinigung-bayern` }, { label: "Reinigung Landshut" }]} />
