...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_mallersdorf_pfaffenberg",
        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-mallersdorf-pfaffenberg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Mallersdorf", href: "/de/umzug-mallersdorf-pfaffenberg" },
                                { name: "Geiselhöring", href: "/de/umzug-geiselhoering" },
                                { name: "Laberweinting", href: "/de/umzug-laberweinting" },
                                ...
                                { name: "Mengkofen", href: "/de/umzug-mengkofen" },
                                { name: "Leiblfing", href: "/de/umzug-leiblfing" },
                                { name: "Schierling", href: "/de/umzug-schierling" },
                                { name: "Langquaid", href: "/de/umzug-langquaid" },
