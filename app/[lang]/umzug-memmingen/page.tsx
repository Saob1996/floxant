...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_memmingen",
        city: "Memmingen",
    });

    return generatePageSEO({
        pageLocale: lang,
        path: `umzug-memmingen`,
        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-memmingen`,
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-memmingen` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Bad Wörishofen", href: "/de/umzug-bad-woerishofen" },
                                { name: "Ottobeuren", href: "/de/umzug-ottobeuren" },
                                { name: "Buxheim", href: "/de/umzug-buxheim" },
                                { name: "Memmingerberg", href: "/de/umzug-memmingerberg" },
                                { name: "Heimertingen", href: "/de/umzug-heimertingen" },
                                { name: "Legau", href: "/de/umzug-legau" },
                                { name: "Tussenhausen", href: "/de/umzug-tussenhausen" },
                                { name: "Kempten", href: "/de/umzug-kempten" },
                                { name: "Ulm", href: "/de/umzug-ulm" },
                                { name: "Ravensburg", href: "/de/umzug-ravensburg" },
