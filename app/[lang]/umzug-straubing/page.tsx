        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-straubing` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Deggendorf", href: "/de/umzug-deggendorf" },
                                { name: "Regensburg", href: "/de/umzug-regensburg" },
                                { name: "Dingolfing", href: "/de/umzug-dingolfing" },
                                { name: "Bogen", href: "/de/umzug-bogen" },
                                ...
                                { name: "Steinach", href: "/de/umzug-steinach" },
                                { name: "Salching", href: "/de/umzug-salching" },
                                { name: "Parkstetten", href: "/de/umzug-parkstetten" },
                                { name: "Atting", href: "/de/umzug-atting" },
