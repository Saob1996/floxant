...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({
        ...
        title: "Umzugsunternehmen Straubing ✓ Festpreis ✓ Versicherung | FLOXANT",
        description: "Professionelles Umzugsunternehmen in Straubing. Umzug, Entrümpelung und Reinigung mit Festpreis und Versicherung. Jetzt Angebot bei FLOXANT anfragen. Sofortpreis online berechnen oder bequem per WhatsApp / Telefon anfragen: +49 1577 1105087.",
    });
}
...
export default async function UmzugStraubing({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const faqJsonLd = {
        ...
        "mainEntity": [
            { "@type": "Question", "name": "Was kostet ein Umzug in Straubing?", "acceptedAnswer": { "@type": "Answer", "text": "Ein lokaler Umzug in Straubing kostet zwischen 400 und 2.000 Euro je nach Wohnungsgröße. FLOXANT bietet verbindliche Festpreise nach kostenloser Besichtigung." } },
            { "@type": "Question", "name": "Macht FLOXANT auch Umzüge in der Altstadt von Straubing?", "acceptedAnswer": { "@type": "Answer", "text": "Ja, wir sind auf schwierige Logistik wie enge Gassen oder viele Treppen spezialisiert und kümmern uns um alle Halteverbotszonen." } },
            { "@type": "Question", "name": "Bieten Sie Fernumzüge ab Straubing an?", "acceptedAnswer": { "@type": "Answer", "text": "Ja. Wir organisieren Fernumzüge von Straubing nach ganz Deutschland." } },
        ],
    };
    ...
    const localBusinessJsonLd = {
        ...
        "url": "https://www.floxant.de/" + lang + "/umzug-straubing",
    ...
    const breadcrumbsJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Umzug Straubing", "item": "https://www.floxant.de/" + lang + "/umzug-straubing" }
        ]
    };
            ...
            <section className="pt-8 pb-20 px-6 bg-gradient-to-b from-muted/20 to-background">
                <div className="max-w-7xl mx-auto text-center space-y-8">
                    ...
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        FLOXANT ist Ihr starker Umzugspartner für Straubing. Wir bieten Festpreisgarantie, voll versicherten Transport und lokale Expertise für Privathaushalte und Firmen.
                    </p>
            ...
            <section className="py-20 px-6">
                <div className="max-w-4xl mx-auto space-y-24">
                    ...
                    <div className="prose prose-lg max-w-none text-muted-foreground">
                        ...
                        <p>Wer nach Straubing zieht, oder die Stadt verlässt, muss oft auch alte Möbel entsorgen. FLOXANT bietet exzellente <Link href={"/" + lang + "/entruempelung"}>Entrümpelungs-Services</Link> an. Wir nehmen anfallenden Sperrmüll sofort am Umzugstag mit und entsorgen ihn fachgerecht bei den lokalen Wertstoffhöfen.</p>
