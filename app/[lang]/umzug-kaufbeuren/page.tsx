...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_kaufbeuren",
        city: "Kaufbeuren",
    });

    return generatePageSEO({
        pageLocale: lang,
        path: `umzug-kaufbeuren`,
        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-kaufbeuren`,
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-kaufbeuren` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                ...
                <section className="bg-slate-50 py-16 px-6 border-t border-border">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                { name: "Kaufbeuren", href: "/de/umzug-kaufbeuren" },
                                { name: "Kempten", href: "/de/umzug-kempten" },
                                { name: "Memmingen", href: "/de/umzug-memmingen" },
                                { name: "Marktoberdorf", href: "/de/umzug-marktoberdorf" },
                                { name: "Füssen", href: "/de/umzug-fuessen" },
                                { name: "Biessenhofen", href: "/de/umzug-biessenhofen" },
                                { name: "Germaringen", href: "/de/umzug-germaringen" },
                                { name: "Pforzen", href: "/de/umzug-pforzen" },
                                { name: "Mauerstetten", href: "/de/umzug-mauerstetten" },
                                { name: "Landsberg am Lech", href: "/de/umzug-landsberg-am-lech" },
                                { name: "Mindelheim", href: "/de/umzug-mindelheim" },
                                { name: "Buchloe", href: "/de/umzug-buchloe" },
