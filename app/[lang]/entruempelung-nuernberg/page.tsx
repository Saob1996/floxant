...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({ lang, path: 'entruempelung-nuernberg', title: 'Entrümpelung Nürnberg | Wohnungsauflösung | FLOXANT', description: 'Professionelle Entrümpelung in Nürnberg. Wohnungsauflösung, Kellerentrümpelung, Sperrmüll. Festpreis & umweltgerechte Entsorgung.' });
}
...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const faqJsonLd = {
        ...
        "mainEntity": [
            { "@type": "Question", "name": "Was kostet eine Entrümpelung in Nürnberg?", "acceptedAnswer": { "@type": "Answer", "text": "30 bis 80 Euro pro Kubikmeter, abhängig von Material und Zugänglichkeit. Festpreis nach Besichtigung." } },
    ...
    const localBusinessJsonLd = {
        ...
        "url": `https://www.floxant.de/${lang}/entruempelung-nuernberg`,
    ...
    const breadcrumbsJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Entrümpelung Nürnberg", "item": `https://www.floxant.de/${lang}/entruempelung-nuernberg` }
        ]
    };
    ...
    return (
        <main className="min-h-screen bg-background">
            ...
            <Breadcrumbs lang={lang} items={[{ label: "Entrümpelung Bayern", href: `/${lang}/entruempelung-bayern` }, { label: "Entrümpelung Nürnberg" }]} />
