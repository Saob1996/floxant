...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({
        ...
        title: "Umzug in Beratzhausen ab 79€ – Sofort verfügbar | FLOXANT",
        description: "Professionelles Umzugsunternehmen für Beratzhausen. ✓ Festpreisgarantie ✓ 100% Versichert ✓ Möbelmontage. Mehr als 100+ erfolgreiche Umzüge. Jetzt Angebot sichern! Sofortpreis online berechnen oder bequem per WhatsApp / Telefon anfragen: +49 1577 1105087.",
    });
}
...
export default async function UmzugBeratzhausen({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const faqJsonLd = {
        ...
        "mainEntity": [
            { "@type": "Question", "name": "Was kostet ein Umzug in Beratzhausen?", "acceptedAnswer": { "@type": "Answer", "text": "Ein Transporter mit Helfern ist oft schon ab günstigen Einstiegspreisen verfügbar. Für den durchschnittlichen Familienhaushalt kalkulieren wir maßgeschneiderte Festpreise, in der Regel zwischen 400€ und 1.500€, abhängig von Raumanzahl und Transportstrecke." } },
            { "@type": "Question", "name": "Wie kurzfristig ist ein Umzugstermin in Beratzhausen verfügbar?", "acceptedAnswer": { "@type": "Answer", "text": "Da sich unsere Disposition im nahen Regensburg befindet, können wir oft auch sehr kurzfristige Umzüge oder Notfall-Termine in Beratzhausen realisieren." } },
            { "@type": "Question", "name": "Kümmern Sie sich um Halteverbotszonen in Beratzhausen?", "acceptedAnswer": { "@type": "Answer", "text": "Ja, absolut. Wenn Parkraum vor Ihrer Haustür knapp ist, organisieren wir die offizielle Beantragung sowie das Aufstellen der Halteverbotsschilder durch die lokalen Behörden." } },
            { "@type": "Question", "name": "Bieten Sie auch Küchenmontage in Beratzhausen an?", "acceptedAnswer": { "@type": "Answer", "text": "Wir demontieren Ihre Küche fachmännisch und verpacken die Teile sicher. Den fachgerechten Wiederaufbau übernehmen wir im Rahmen der Machbarkeiten ebenfalls gerne." } },
    ...
    const localBusinessJsonLd = {
        ...
        "url": "https://www.floxant.de/" + lang + "/umzug-beratzhausen",
    ...
    const breadcrumbsJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Umzug Beratzhausen", "item": "https://www.floxant.de/" + lang + "/umzug-beratzhausen" }
        ]
    };
    ...
    return (
        <main className="min-h-screen bg-background">
            ...
            <Breadcrumbs lang={lang} items={[{ label: "Umzug Region Regensburg", href: "/" + lang + "/umzug-regensburg" }, { label: "Umzug Beratzhausen" }]} />
