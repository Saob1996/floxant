        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-brennberg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Altenthann", href: "/de/umzug-altenthann" },
                                { name: "Wald", href: "/de/umzug-wald" },
                                { name: "Bernhardswald", href: "/de/umzug-bernhardswald" },
                                ...
                                { name: "Michelsneukirchen", href: "/de/umzug-michelsneukirchen" },
                                { name: "Falkenstein", href: "/de/umzug-falkenstein" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
