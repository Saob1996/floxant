...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_neustadt_an_der_donau",
        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-neustadt-an-der-donau` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Münchsmünster", href: "/de/umzug-muenchsmuenster" },
                                { name: "Vohburg", href: "/de/umzug-vohburg" },
                                { name: "Bad Gögging", href: "/de/umzug-bad-goegging" },
                                { name: "Biburg", href: "/de/umzug-biburg" },
                                { name: "Pfettrach", href: "/de/umzug-pfettrach" },
