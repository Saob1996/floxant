        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-hausen`,
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-hausen` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Rohr", href: "/de/umzug-rohr-in-niederbayern" },
                                { name: "Teugn", href: "/de/umzug-teugn" },
                                { name: "Herrngiersdorf", href: "/de/umzug-herrngiersdorf" },
                                { name: "Schierling", href: "/de/umzug-schierling" },
                                { name: "Biburg", href: "/de/umzug-biburg" },
                                { name: "Wildenberg", href: "/de/umzug-wildenberg" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
