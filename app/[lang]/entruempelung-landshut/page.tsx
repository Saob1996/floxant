...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({
        ...
        title: 'Entrümpelung in Landshut | FLOXANT',
        description: 'Professionelle Entrümpelung in Landshut in Bayern. Seriöse Abwicklung, Festpreisgarantie und versicherter Transport. Jetzt online berechnen!',
    });
}
...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const faqJsonLd = {
        ...
        "mainEntity": [
                { "@type": "Question", "name": content.faqs?.[0]?.q || "Was kostet eine Entrümpelung in Landshut?", "acceptedAnswer": { "@type": "Answer", "text": content.faqs?.[0]?.a || "30 bis 80 Euro pro Kubikmeter, abhängig von Material und Zugänglichkeit. Festpreis nach Besichtigung." } },
    ...
    const localBusinessJsonLd = {
        ...
        "name": "FLOXANT Entrümpelung Landshut",
        "url": `https://www.floxant.de/${pageLocale}/entruempelung-landshut`,
    ...
    const breadcrumbsJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Entrümpelung Landshut", "item": `https://www.floxant.de/${pageLocale}/entruempelung-landshut` }
        ]
    };

    return (
        <main className="min-h-screen bg-background">
            <Breadcrumbs pageLocale={pageLocale} items={[{ label: "Entrümpelung Bayern", href: `/${pageLocale}/entruempelung-bayern` }, { label: "Entrümpelung Landshut" }]} />
            ...
            <section className="pt-8 pb-20 px-6 bg-gradient-to-b from-muted/20 to-background">
                <div className="max-w-7xl mx-auto text-center space-y-8">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-foreground">
                        Entrümpelung in <span className="text-primary">Landshut</span>
                    </h1>
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        FLOXANT bietet professionelle Entrümpelung in Landshut und Umgebung. Ob Wohnungsauflösung, Kellerentrümpelung oder Dachbodenräumung – wir erledigen alles schnell, sauber und zu fairen Festpreisen.
                    </p>
                </div>
            </section>
            ...
            <section className="py-20 px-6">
                <div className="max-w-4xl mx-auto space-y-16">
                    <div className="prose prose-lg max-w-none text-muted-foreground">
                        <h2 className="text-3xl font-bold text-foreground mb-6">Entrümpelung in Landshut – schnell & sauber</h2>
                        <p>Unsere erfahrenen Teams räumen Wohnungen, Keller, Dachböden und Büros in Landshut professionell. Verwertbare Gegenstände werden gegengerechnet, alles andere umweltgerecht entsorgt.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            {[
                            { q: "Was kostet eine Entrümpelung in Landshut?", a: "30 bis 80 Euro pro Kubikmeter, abhängig von Material und Zugänglichkeit. Festpreis nach Besichtigung." },
                    ...
                    <div className="border-t border-border pt-12">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link href={`/${pageLocale}/umzug-landshut`} className="px-4 py-2 rounded-full border border-border/50 text-sm text-muted-foreground hover:text-primary hover:border-primary/30 transition-all">Umzug Landshut</Link>
                    ...
                    <div className="text-center py-10 bg-gradient-to-br from-primary/5 via-transparent to-primary/5 rounded-3xl border border-primary/10 shadow-lg">
                        <h2 className="text-3xl font-bold mb-4">Entrümpelung in Landshut anfragen</h2>
                        <p className="text-muted-foreground mb-8 max-w-xl mx-auto">Kostenloses Festpreisangebot für Entrümpelung in Landshut.</p>
