...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({ lang, path: 'entruempelung-landshut', title: 'Entrümpelung Landshut | Wohnungsauflösung | FLOXANT', description: 'Professionelle Entrümpelung in Landshut. Wohnungsauflösung, Kellerentrümpelung, Sperrmüll. Festpreis & umweltgerechte Entsorgung.' });
}
...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const faqJsonLd = {
        ...
        "mainEntity": [
            { "@type": "Question", "name": "Was kostet eine Entrümpelung in Landshut?", "acceptedAnswer": { "@type": "Answer", "text": "30 bis 80 Euro pro Kubikmeter, abhängig von Material und Zugänglichkeit. Festpreis nach Besichtigung." } },
    ...
    const localBusinessJsonLd = {
        ...
        "url": `https://www.floxant.de/${lang}/entruempelung-landshut`,
