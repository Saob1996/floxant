...
export default async function KurzfristigerUmzugBayern({ params }: { params: Promise<{ lang: string }> }) {
    ...
    return (
        <main className="min-h-screen bg-background">
            <Breadcrumbs pageLocale={pageLocale} items={[{ label: "Umzug Bayern", href: `/${pageLocale}/umzug-bayern` }, { label: "Kurzfristiger Umzug" }]} />
                ...
                <div className="max-w-4xl mx-auto space-y-24">
                    ...
                    <div className="border-t border-border pt-12">
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <Link href={`/${pageLocale}/notfall-umzug-bayern`} className="px-4 py-2 rounded-full border border-border/50 text-sm text-muted-foreground hover:text-primary hover:border-primary/30 transition-all">Notfall-Umzug</Link>
