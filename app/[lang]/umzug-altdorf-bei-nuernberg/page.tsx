...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_altdorf_bei_nuernberg",
        ...
        "@graph": [
            {
                ...
                "address": {
                    "@type": "PostalAddress",
                    "addressLocality": "Altdorf bei Nürnberg",
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-altdorf-bei-nuernberg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Lauf an der Pegnitz", href: "/de/umzug-lauf-an-der-pegnitz" },
                                { name: "Leinburg", href: "/de/umzug-leinburg" },
                                { name: "Winkelhaid", href: "/de/umzug-winkelhaid" },
                                { name: "Neumarkt", href: "/de/umzug-neumarkt" },
                                { name: "Hersbruck", href: "/de/umzug-hersbruck" },
                                { name: "Burgthann", href: "/de/umzug-burgthann" },
                                { name: "Happurg", href: "/de/umzug-happurg" },
