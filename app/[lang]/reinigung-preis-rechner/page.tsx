...
export const metadata = {
  ...
  description: 'Berechnen Sie sofort Ihre Reinigungskosten. Ob Grundreinigung oder Spezialauftrag – unser Dual-Calculator zeigt Ihnen sekundenschnell ein Festpreis-Angebot. Sofortpreis online berechnen oder bequem per WhatsApp / Telefon anfragen: +49 1577 1105087.',
};

export default function ReinigungPreisRechnerPage() {
  const jsonLd = {
