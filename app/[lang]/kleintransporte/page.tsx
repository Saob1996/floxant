...
export async function generateMetadata({
    ...
    const { content, fallback, seoContent, seoFallback, city } =
        await getSpecialtyPageData({
            locale: pageLocale,
            baseKey: "kleintransport",
            seoKey: "kleintransport_bayern",
            city: CITY,
        });
...
export default async function KleintransportePage({
    ...
    const heroTitle =
        resolveField(content.hero_h1, fallback.hero_h1) || "Kleintransporte";
