...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_woerth_an_der_donau",
        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-woerth-an-der-donau` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Wörth an der Donau", href: "/de/umzug-woerth-an-der-donau" },
                                { name: "Wiesent", href: "/de/umzug-wiesent" },
                                { name: "Bach an der Donau", href: "/de/umzug-bach-an-der-donau" },
                                { name: "Pfatter", href: "/de/umzug-pfatter" },
                                { name: "Donaustauf", href: "/de/umzug-donaustauf" },
                                { name: "Tegernheim", href: "/de/umzug-tegernheim" },
                                { name: "Brennberg", href: "/de/umzug-brennberg" },
                                { name: "Rettenbach", href: "/de/umzug-rettenbach" },
                                { name: "Wald", href: "/de/umzug-wald" },
                                { name: "Straubing", href: "/de/umzug-straubing" },
                                { name: "Kirchroth", href: "/de/umzug-kirchroth" },
                                { name: "Aiterhofen", href: "/de/umzug-aiterhofen" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
