...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_maxhuette_haidhof",
        ...
        "@graph": [
            {
                ...
                "address": {
                    "@type": "PostalAddress",
                    "addressLocality": "Maxhütte-Haidhof",
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-maxhuette-haidhof` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Holzheim", href: "/de/umzug-holzheim-am-forst" },
