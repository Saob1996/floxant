...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({
        pageLocale,
        path: 'reinigung-passau',
        title: 'Professionelle Reinigung in Passau | FLOXANT',
        description: 'Professionelle Professionelle Reinigung in Passau in Bayern. Seriöse Abwicklung, Festpreisgarantie und versicherter Transport. Jetzt online berechnen!',
    });
}
...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const faqJsonLd = {
        ...
        "mainEntity": [
                { "@type": "Question", "name": content.faqs?.[0]?.q || "Was kostet eine Reinigung in Passau?", "acceptedAnswer": { "@type": "Answer", "text": content.faqs?.[0]?.a || "3 bis 5 Euro pro Quadratmeter für eine professionelle Endreinigung. Festpreis nach Besichtigung." } },
    ...
    const localBusinessJsonLd = {
        ...
        "name": "FLOXANT Reinigung Passau",
        "url": `https://www.floxant.de/${pageLocale}/reinigung-passau`,
    ...
    const serviceJsonLd = {
        ...
        "provider": { "@type": "LocalBusiness", "name": "FLOXANT Reinigung Passau", "telephone": "+4915771105087" },
        "areaServed": { "@type": "City", "name": "Passau" }
    };
    ...
    const breadcrumbsJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Reinigung Passau", "item": `https://www.floxant.de/${pageLocale}/reinigung-passau` }
        ]
    };

    return (
        <main className="min-h-screen bg-background">
            <Breadcrumbs pageLocale={pageLocale} items={[{ label: "Reinigung Bayern", href: `/${pageLocale}/reinigung-bayern` }, { label: "Reinigung Passau" }]} />
            ...
            <section className="pt-8 pb-20 px-6 bg-gradient-to-b from-muted/20 to-background">
                <div className="max-w-7xl mx-auto text-center space-y-8">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-foreground">
                        Professionelle Reinigung in <span className="text-primary">Passau</span>
                    </h1>
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        FLOXANT bietet professionelle Reinigungsservices in Passau und Umgebung. Von der Endreinigung bei der Wohnungsübergabe bis zur Grundreinigung – wir garantieren ein Ergebnis, das jeden Vermieter überzeugt.
                    </p>
                </div>
            </section>
            ...
            <section className="py-20 px-6">
                <div className="max-w-4xl mx-auto space-y-16">
                    <div className="prose prose-lg max-w-none text-muted-foreground">
                        <h2 className="text-3xl font-bold text-foreground mb-6">Endreinigung in Passau</h2>
                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            {[
                            { q: "Was kostet eine Reinigung in Passau?", a: "3 bis 5 Euro pro Quadratmeter für eine professionelle Endreinigung. Festpreis nach Besichtigung." },
                    ...
                    <div className="text-center py-10 bg-gradient-to-br from-primary/5 via-transparent to-primary/5 rounded-3xl border border-primary/10 shadow-lg">
                        <h2 className="text-3xl font-bold mb-4">Reinigung in Passau anfragen</h2>
                        <p className="text-muted-foreground mb-8 max-w-xl mx-auto">Kostenloses Festpreisangebot für Reinigung in Passau.</p>
