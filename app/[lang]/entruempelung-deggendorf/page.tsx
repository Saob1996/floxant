...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        seoKey: "entruempelung_deggendorf",
        city: "Deggendorf",
    });

    return generatePageSEO({
        pageLocale: lang,
        path: `entruempelung-deggendorf`,
        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/entruempelung-deggendorf` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
