...
export default async function SeniorenumzugPage({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const faqJsonLd = {
        ...
        "mainEntity": [
            ...
            { "@type": "Question", "name": "Wie viel kostet ein Seniorenumzug in München?", "acceptedAnswer": { "@type": "Answer", "text": "Die Kosten richten sich nach Wohnungsgröße und gewünschten Zusatzleistungen. Ein Full-Service Seniorenumzug mit Einpacken liegt typischerweise 30-50% über einem Standard-Umzug, eliminiert dafür aber jeglichen Stress." } },
    ...
    return (
        <main className="min-h-screen bg-background">
            ...
            <Breadcrumbs lang={lang} items={[{ label: "Umzug München", href: "/" + lang + "/umzug-muenchen" }, { label: "Seniorenumzug München" }]} />
            ...
            <section className="py-16 px-6">
                <div className="max-w-4xl mx-auto space-y-12">
                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                        ...
                        <Link href={"/" + lang + "/klaviertransport-muenchen"} className="px-5 py-3 rounded-2xl border border-border/50 bg-card text-sm font-semibold hover:border-primary/50 transition-all">Klaviertransport München</Link>
