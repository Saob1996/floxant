...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    const content = dict?.pages?.seniorenumzug_muenchen || {};
    return generatePageSEO({
        pageLocale,
        path: "seniorenumzug-muenchen",
        title: content.meta_title || "Seniorenumzug München – Einfühlsam & Sicher | FLOXANT",
        description: content.meta_desc || `Seniorenumzug in München: Kompletter Einpackservice, Möbelmontage, Behördenhilfe. Empathisches Team, fester Preis, volle Versicherung. Jetzt beraten lassen! Sofortpreis online berechnen oder bequem per WhatsApp / Telefon anfragen: +49 1577 1105087.`,
    });
}
...
export default async function SeniorenumzugPage({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const serviceJsonLd = {
        ...
        "description": "Einfühlsamer Umzugsservice speziell für Senioren in München. Kompletter Einpackservice, Möbelmontage, Behördenunterstützung.",
    };
    ...
    const faqJsonLd = {
        ...
        "mainEntity": [
                ...
                { "@type": "Question", "name": content.faqs?.[1]?.q || "Wie viel kostet ein Seniorenumzug in München?", "acceptedAnswer": { "@type": "Answer", "text": content.faqs?.[1]?.a || "Die Kosten richten sich nach Wohnungsgröße und gewünschten Zusatzleistungen. Ein Full-Service Seniorenumzug mit Einpacken liegt typischerweise 30-50% über einem Standard-Umzug, eliminiert dafür aber jeglichen Stress." } },
    ...
    return (
        <main className="min-h-screen bg-background">
            <Breadcrumbs pageLocale={pageLocale} items={[{ label: "Umzug München", href: "/" + pageLocale + "/umzug-muenchen" }, { label: "Seniorenumzug München" }]} />
            ...
            <section className="pt-12 pb-24 px-6 bg-gradient-to-b from-rose-50 dark:from-rose-950/20 via-muted/30 to-background overflow-hidden relative">
                <div className="max-w-7xl mx-auto text-center space-y-8 relative z-10">
                    ...
                    <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-foreground leading-tight">
                        ...
                        <span className="text-rose-600 dark:text-rose-400">München</span>
                    </h1>
            ...
            <section className="py-16 px-6 bg-muted/20">
                <div className="max-w-4xl mx-auto prose prose-xl text-muted-foreground leading-loose">
                    <h2 className="text-3xl font-extrabold text-foreground">Seniorenumzug in München: Lokalwissen trifft Einfühlungsvermögen</h2>
                    <p>In München kennen wir die Wohnsituation genau. Ob Sie aus einer langjährigen Mietwohnung in Schwabing, Bogenhausen, Sendling, Pasing, Haidhausen, Neuhausen, Laim, Berg am Laim in eine barrierefreie Seniorenresidenz wechseln oder zu Ihren Kindern ziehen – wir planen den gesamten Prozess mit Ihnen gemeinsam.</p>
                    ...
                    <p>Typische Projekte in München: Wechsel ins betreute Wohnen, Verkleinerung von 4 auf 2 Zimmer, Zusammenzug mit dem Partner, Nachzug zu den Kindern in eine andere Stadt. Für jeden dieser Fälle haben wir erprobte Abläufe.</p>
                    ...
                    <div className="not-prose mt-12 p-8 bg-card rounded-3xl border border-border shadow-sm">
                        ...
                        <p className="text-muted-foreground mb-2"><em>"Frau K. (78) zog aus ihrer 3-Zimmer-Wohnung in Schwabing in eine Seniorenresidenz. Unser Team hat an zwei Tagen die gesamte Wohnung eingepackt, die Möbel demontiert und im neuen Zimmer alles wieder aufgebaut. Am zweiten Abend hingen sogar die Bilder."</em></p>
                        <p className="text-sm text-muted-foreground">– FLOXANT Seniorenumzug-Team München</p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 px-6">
                <div className="max-w-4xl mx-auto space-y-12">
                    <div id="wizard" className="text-center py-16 bg-card rounded-[3rem] border border-border shadow-2xl relative scroll-mt-24">
                        ...
                        <h2 className="text-4xl font-extrabold mb-6 mt-6">Seniorenumzug in München anfragen</h2>
                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                        ...
                        <Link href={"/" + pageLocale + "/klaviertransport-muenchen"} className="px-5 py-3 rounded-2xl border border-border/50 bg-card text-sm font-semibold hover:border-primary/50 transition-all">Klaviertransport München</Link>
