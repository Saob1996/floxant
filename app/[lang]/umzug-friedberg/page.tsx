        ...
        "@graph": [
            {
                ...
                "address": {
                    "@type": "PostalAddress",
                    "addressLocality": "Friedberg (Bayern)",
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-friedberg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Affing", href: "/de/umzug-affing" },
                                { name: "Obergriesbach", href: "/de/umzug-obergriesbach" },
                                { name: "Dasing", href: "/de/umzug-dasing" },
                                { name: "Aichach", href: "/de/umzug-aichach" },
