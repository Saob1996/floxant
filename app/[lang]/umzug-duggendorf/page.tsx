        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-duggendorf` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Kallmünz", href: "/de/umzug-kallmuenz" },
                                { name: "Duggendorf", href: "/de/umzug-duggendorf" },
                                { name: "Pielenhofen", href: "/de/umzug-pielenhofen" },
                                { name: "Wolfsegg", href: "/de/umzug-wolfsegg" },
                                { name: "Holzheim am Forst", href: "/de/umzug-holzheim-am-forst" },
                                { name: "Pettendorf", href: "/de/umzug-pettendorf" },
                                { name: "Sinzing", href: "/de/umzug-sinzing" },
