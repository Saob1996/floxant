        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-vohburg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Pförring", href: "/de/umzug-pfoerring" },
                                ...
                                { name: "Ernsgaden", href: "/de/umzug-ernsgaden" },
                                { name: "Regsburg", href: "/de/umzug-regensburg" },
