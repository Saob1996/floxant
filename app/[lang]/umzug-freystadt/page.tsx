        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-freystadt` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Postbauer-Heng", href: "/de/umzug-postbauer-heng" },
                                { name: "Allersberg", href: "/de/umzug-allersberg" },
                                ...
                                { name: "Pyrbaum", href: "/de/umzug-pyrbaum" },
