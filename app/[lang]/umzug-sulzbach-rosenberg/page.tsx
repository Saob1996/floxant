...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_sulzbach_rosenberg",
        city: "Sulzbach-Rosenberg",
    });

    return generatePageSEO({
        pageLocale: lang,
        path: `umzug-sulzbach-rosenberg`,
        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-sulzbach-rosenberg`,
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-sulzbach-rosenberg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Auerbach", href: "/de/umzug-auerbach-in-der-oberpfalz" },
                                { name: "Vilseck", href: "/de/umzug-vilseck" },
                                { name: "Hahnbach", href: "/de/umzug-hahnbach" },
                                { name: "Hirschau", href: "/de/umzug-hirschau" },
                                { name: "Schnaittenbach", href: "/de/umzug-schnaittenbach" },
                                { name: "Königstein", href: "/de/umzug-koenigstein" },
                                { name: "Poppenricht", href: "/de/umzug-poppenricht" },
                                { name: "Neukirchen", href: "/de/umzug-neukirchen-bei-sulzbach-rosenberg" },
                                { name: "Illschwang", href: "/de/umzug-illschwang" },
                                { name: "Etzelwang", href: "/de/umzug-etzelwang" },
