...
export default async function ReinigungBayernPage({ params }: PageProps) {
    const { lang } = await params;
        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 2, "name": `Reinigung ${city}`, "item": `https://www.floxant.de/${lang}/reinigung-bayern` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
