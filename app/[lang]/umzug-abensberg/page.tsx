        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-abensberg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Neustadt a.d. Donau", href: "/de/umzug-neustadt-an-der-donau" },
                                ...
                                { name: "Rohr i.NB", href: "/de/umzug-rohr-inf-niederbayern" },
                                { name: "Langquaid", href: "/de/umzug-langquaid" },
                                { name: "Saal a.d. Donau", href: "/de/umzug-saal-an-der-donau" },
                                { name: "Ihringen", href: "/de/umzug-ihringen" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
