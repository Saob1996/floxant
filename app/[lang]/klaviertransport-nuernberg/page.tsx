...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({
        lang,
        path: "klaviertransport-nuernberg",
        title: "Klaviertransport & Tresortransport Nürnberg | FLOXANT Schwertransporte",
        description: "Klaviertransport, Flügeltransport und Tresortransport in Nürnberg. Spezialisiertes Equipment, geschultes Team, volle Versicherung. Jetzt anfragen! Sofortpreis online berechnen oder bequem per WhatsApp / Telefon anfragen: +49 1577 1105087.",
    });
}
...
export default async function KlaviertransportPage({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const serviceJsonLd = {
        ...
        "name": "Klaviertransport & Tresortransport Nürnberg",
        "provider": {
        ...
        "areaServed": { "@type": "City", "name": "Nürnberg", "geo": { "@type": "GeoCoordinates", "latitude": "49.4521", "longitude": "11.0767" } },
    ...
    return (
        <main className="min-h-screen bg-background">
            ...
            <Breadcrumbs lang={lang} items={[{ label: "Umzug Nürnberg", href: "/" + lang + "/umzug-nuernberg" }, { label: "Klavier- & Tresortransport" }]} />
            ...
            <section className="py-24 px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="prose prose-xl max-w-none text-muted-foreground leading-loose">
                        <h2 className="text-3xl font-extrabold text-foreground">Schwertransporte in Nürnberg: lokales Können</h2>
                        <p>In Nürnberg erleben wir häufig Klaviertransporte aus Altbauwohnungen in Altstadt oder  Gostenhof. Die Herausforderung: enge Treppenhäuser, keine Aufzüge, Wendeltreppen. Unsere Lösung: Außenlift oder Krantransport über den Balkon – je nach Situation.</p>
                        <p>Tresortransporte sind dagegen oft Firmenkunden-Aufträge. Wir transportieren Waffenschränke, Datensafes und Dokumententresore sowohl innerhalb von Nürnberg als auch überregional. Dabei garantieren wir absolute Diskretion und volle Versicherungsdeckung.</p>
                    </div>
                    ...
                    <div id="wizard" className="text-center py-16 bg-card rounded-[3rem] border border-border shadow-2xl relative mt-16 scroll-mt-24">
                        ...
                        <h2 className="text-4xl font-extrabold mb-6 mt-6">Schwertransport in Nürnberg anfragen</h2>
                    ...
                    <div className="flex flex-wrap justify-center gap-3 mt-8">
                        ...
                        <Link href={"/" + lang + "/seniorenumzug-nuernberg"} className="px-5 py-3 rounded-2xl border border-border/50 bg-card text-sm font-semibold hover:border-primary/50 transition-all">Seniorenumzug Nürnberg</Link>
                        <Link href={"/" + lang + "/halteverbotszone-nuernberg"} className="px-5 py-3 rounded-2xl border border-border/50 bg-card text-sm font-semibold hover:border-primary/50 transition-all">Halteverbotszone Nürnberg</Link>
                    </div>
                </div>
            </section>
        </main>
