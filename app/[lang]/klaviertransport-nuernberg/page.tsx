...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "service_schwertransport",
        seoKey: "klaviertransport_nuernberg",
        city: "Nürnberg",
    });
...
export default async function KlaviertransportNuernbergPage({ params }: PageProps) {
    const { lang } = await params;
    ...
    const jsonLd = {
        ...
        "@graph": [
            {
                "@type": "Service",
                "name": `Klaviertransport ${city} | FLOXANT`,
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/klaviertransport-nuernberg`,
                "provider": {
                    "@type": "LocalBusiness",
                    "name": "FLOXANT",
