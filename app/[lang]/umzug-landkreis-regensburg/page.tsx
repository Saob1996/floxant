...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_landkreis_regensburg",
        ...
        "@graph": [
            {
                ...
                "name": `FLOXANT ${city}`,
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-landkreis-regensburg`,
                "provider": {
                    "@type": "LocalBusiness",
                    "name": "FLOXANT",
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-landkreis-regensburg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
            ...
            {lang === "de" && (
                <section className="bg-slate-50 py-16 px-6 border-t border-border">
                    <div className="max-w-4xl mx-auto">
                        <h3 className="text-xl font-bold mb-8 text-slate-800">Umzug Landkreis Regensburg: Gemeinden</h3>
