...
export default async function HalteverbotszoneMuenchenPage({ params }: PageProps) {
    const { lang } = await params;
    ...
    const jsonLd = {
        ...
        "@graph": [
            {
                "@type": "Service",
                "name": `Halteverbotszone ${city} | FLOXANT`,
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/halteverbotszone-muenchen`,
                "provider": {
                    "@type": "LocalBusiness",
                    "name": "FLOXANT",
