...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_deggendorf",
        city: "Deggendorf",
    });

    return generatePageSEO({
        pageLocale: lang,
        path: `umzug-deggendorf`,
        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-deggendorf`,
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-deggendorf` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Plattling", href: "/de/umzug-plattling" },
                                { name: "Vilshofen", href: "/de/umzug-vilshofen" },
                                { name: "Osterhofen", href: "/de/umzug-osterhofen" },
                                { name: "Hengersberg", href: "/de/umzug-hengersberg" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
