...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    const content = dict?.pages?.umzug_rottenburg_an_der_laaber || {};
    return generatePageSEO({
        pageLocale,
        path: "umzug-rottenburg-an-der-laaber",
        title: content.meta_title || "Umzug in Rottenburg an der Laaber ab 79€ | FLOXANT",
        description: 'Professionelles Umzugsunternehmen für Rottenburg an der Laaber. ✓ $... ✓ $.... Sofort anfragen!',
    });
}
...
export default async function UmzugRottenburganderlaaber({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const localBusinessJsonLd = {
        ...
        "url": "https://www.floxant.de/" + pageLocale + "/umzug-rottenburg-an-der-laaber",
    ...
    const breadcrumbsJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Umzug Rottenburg an der Laaber", "item": "https://www.floxant.de/" + pageLocale + "/umzug-rottenburg-an-der-laaber" }
        ]
    };

    return (
        <main className="min-h-screen bg-background">
            <Breadcrumbs pageLocale={pageLocale} items={[{ label: "Umzug Region Regensburg", href: "/" + pageLocale + "/umzug-regensburg" }, { label: "Umzug Rottenburg an der Laaber" }]} />
                ...
                <div className="max-w-4xl mx-auto space-y-24">
                    ...
                    <div className="border-t border-border pt-16">
                        ...
                        <div className="flex flex-wrap justify-center gap-3">
                            ...
                            <Link href={"/" + pageLocale + "/umzug-woerth-an-der-donau"} className="px-4 py-2 rounded-full border border-border/50 text-sm font-medium text-muted-foreground hover:text-primary hover:border-primary/50 transition-all bg-card/50">Umzug Wörth an der Donau</Link>
