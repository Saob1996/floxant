...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        seoKey: "klaviertransport_regensburg",
        city: "Regensburg",
    });
...
export default async function KlaviertransportRegensburgPage({ params }: PageProps) {
    const { lang } = await params;
        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/klaviertransport-regensburg`,
                "provider": {
                    "@type": "LocalBusiness",
                    "name": "FLOXANT",
