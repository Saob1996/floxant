...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({
        ...
        title: "Klaviertransport & Tresortransport Regensburg | FLOXANT Schwertransporte",
        description: "Klaviertransport, Flügeltransport und Tresortransport in Regensburg. Spezialisiertes Equipment, geschultes Team, volle Versicherung. Jetzt anfragen! Sofortpreis online berechnen oder bequem per WhatsApp / Telefon anfragen: +49 1577 1105087.",
    });
}
...
export default async function KlaviertransportPage({ params }: { params: Promise<{ lang: string }> }) {
    ...
    return (
        <main className="min-h-screen bg-background">
            ...
            <Breadcrumbs lang={lang} items={[{ label: "Umzug Regensburg", href: "/" + lang + "/umzug-regensburg" }, { label: "Klavier- & Tresortransport" }]} />
            ...
            <section className="py-24 px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-wrap justify-center gap-3 mt-8">
                        ...
                        <Link href={"/" + lang + "/seniorenumzug-regensburg"} className="px-5 py-3 rounded-2xl border border-border/50 bg-card text-sm font-semibold hover:border-primary/50 transition-all">Seniorenumzug Regensburg</Link>
