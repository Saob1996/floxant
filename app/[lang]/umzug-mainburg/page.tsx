        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-mainburg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Elsendorf", href: "/de/umzug-elsendorf" },
                                { name: "Attenhofen", href: "/de/umzug-attenhofen" },
                                { name: "Volkenschwand", href: "/de/umzug-volkenschwand" },
