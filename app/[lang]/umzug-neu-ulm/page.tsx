        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-neu-ulm`,
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-neu-ulm` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Senden", href: "/de/umzug-senden" },
                                { name: "Vöhringen", href: "/de/umzug-voehringen" },
                                { name: "Illertissen", href: "/de/umzug-illertissen" },
                                { name: "Weißenhorn", href: "/de/umzug-weissenhorn" },
                                { name: "Günzburg", href: "/de/umzug-guenzburg" },
                                { name: "Leipheim", href: "/de/umzug-leipheim" },
                                { name: "Pfaffenhofen", href: "/de/umzug-pfaffenhofen-an-der-roth" },
                                { name: "Elchingen", href: "/de/umzug-elchingen" },
                                { name: "Nersingen", href: "/de/umzug-nersingen" },
                                { name: "Holzheim", href: "/de/umzug-holzheim" },
