        ...
        "@graph": [
            {
                ...
                "address": {
                    "@type": "PostalAddress",
                    "addressLocality": "Moosburg an der Isar",
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-moosburg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Freising", href: "/de/umzug-freising" },
                                { name: "Mainburg", href: "/de/umzug-mainburg" },
                                { name: "Erding", href: "/de/umzug-erding" },
                                { name: "Nandlstadt", href: "/de/umzug-nandlstadt" },
                                { name: "Au in der Hallertau", href: "/de/umzug-au-in-der-hallertau" },
                                { name: "Wartenberg", href: "/de/umzug-wartenberg" },
                                { name: "Mauern", href: "/de/umzug-mauern" },
                                { name: "Zolling", href: "/de/umzug-zolling" },
                                { name: "Neufahrn", href: "/de/umzug-neufahrn-bei-freising" },
                                { name: "Marzling", href: "/de/umzug-marzling" },
                                { name: "Langenbach", href: "/de/umzug-langenbach" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
