        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-seubersdorf` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Seubersdorf", href: "/de/umzug-seubersdorf" },
                                { name: "Parsberg", href: "/de/umzug-parsberg" },
                                { name: "Velburg", href: "/de/umzug-velburg" },
                                { name: "Deining", href: "/de/umzug-deining" },
                                { name: "Lupburg", href: "/de/umzug-lupburg" },
                                { name: "Breitenbrunn", href: "/de/umzug-breitenbrunn" },
                                { name: "Batzhausen", href: "/de/umzug-batzhausen" },
                                { name: "Hohenfels", href: "/de/umzug-hohenfels" },
                                { name: "Hemau", href: "/de/umzug-hemau" },
                                { name: "Beratzhausen", href: "/de/umzug-beratzhausen" },
