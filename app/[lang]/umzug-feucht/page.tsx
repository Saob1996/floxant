...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        alternates: {
            canonical: `https://www.floxant.de/${lang}/umzug-feucht`,
            languages: i18n.locales.reduce((acc, l) => { acc[l] = `https://www.floxant.de/${l}/umzug-feucht`; return acc; }, {} as Record<string, string>),
        },
    };
}
