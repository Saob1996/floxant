...
export default async function UmzugAugsburgPage({ params }: PageProps) {
    const { lang } = await params;
        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-augsburg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Neusäß", href: "/de/umzug-neusaess" },
                                { name: "Gersthofen", href: "/de/umzug-gersthofen" },
                                { name: "Friedberg", href: "/de/umzug-friedberg" },
                                { name: "Stadtbergen", href: "/de/umzug-stadtbergen" },
                                { name: "Königsbrunn", href: "/de/umzug-koenigsbrunn" },
                                { name: "Bobingen", href: "/de/umzug-bobingen" },
                                { name: "Mering", href: "/de/umzug-mering" },
                                { name: "Dasing", href: "/de/umzug-dasing" },
                                { name: "Aystetten", href: "/de/umzug-aystetten" },
                                { name: "Adelsried", href: "/de/umzug-adelsried" },
                                { name: "Diedorf", href: "/de/umzug-diedorf" },
                                { name: "Kissing", href: "/de/umzug-kissing" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
