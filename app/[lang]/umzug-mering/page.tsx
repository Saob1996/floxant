        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-mering` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Merching", href: "/de/umzug-merching" },
                                { name: "Steindorf", href: "/de/umzug-steindorf" },
                                { name: "Schmiechen", href: "/de/umzug-schmiechen" },
                                { name: "Ried", href: "/de/umzug-ried" },
                                { name: "Althegnenberg", href: "/de/umzug-althegnenberg" },
                                { name: "Egling am Paar", href: "/de/umzug-egling-am-paar" },
                                { name: "Prittriching", href: "/de/umzug-prittriching" },
