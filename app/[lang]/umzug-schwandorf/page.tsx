        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-schwandorf` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Wackersdorf", href: "/de/umzug-wackersdorf" },
                                { name: "Steinberg am See", href: "/de/umzug-steinberg-am-see" },
                                { name: "Schwarzenfeld", href: "/de/umzug-schwarzenfeld" },
                                ...
                                { name: "Stulln", href: "/de/umzug-stulln" },
                                { name: "Schmidgaden", href: "/de/umzug-schmidgaden" },
                                { name: "Fensterbach", href: "/de/umzug-fensterbach" },
                                { name: "Ebermannsdorf", href: "/de/umzug-ebermannsdorf" },
                                { name: "Kümmergsbruck", href: "/de/umzug-kuemmersbruck" },
