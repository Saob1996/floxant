        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-roth` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Georgensgmünd", href: "/de/umzug-georgensgmuend" },
                                { name: "Büchenbach", href: "/de/umzug-buechenbach" },
                                { name: "Spalt", href: "/de/umzug-spalt" },
                                { name: "Hilpoltstein", href: "/de/umzug-hilpoltstein" },
                                { name: "Heideck", href: "/de/umzug-heideck" },
                                { name: "Allersberg", href: "/de/umzug-allersberg" },
                                { name: "Röttenbach", href: "/de/umzug-roettenbach" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
