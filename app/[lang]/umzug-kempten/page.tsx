        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-kempten`,
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-kempten` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Immenstadt", href: "/de/umzug-immenstadt" },
                                { name: "Sonthofen", href: "/de/umzug-sonthofen" },
                                { name: "Oberstdorf", href: "/de/umzug-oberstdorf" },
                                { name: "Füssen", href: "/de/umzug-fuessen" },
                                { name: "Marktoberdorf", href: "/de/umzug-marktoberdorf" },
                                { name: "Leutkirch", href: "/de/umzug-leutkirch" },
                                { name: "Isny", href: "/de/umzug-isny" },
                                { name: "Wangen", href: "/de/umzug-wangen" },
