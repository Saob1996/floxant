        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-erding` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Markt Schwaben", href: "/de/umzug-markt-schwaben" },
                                { name: "Moosburg", href: "/de/umzug-moosburg" },
                                { name: "Dorfen", href: "/de/umzug-dorfen" },
                                { name: "Taufkirchen", href: "/de/umzug-taufkirchen-vils" },
                                { name: "Finsing", href: "/de/umzug-finsing" },
                                { name: "Oberding", href: "/de/umzug-oberding" },
                                { name: "Isen", href: "/de/umzug-isen" },
                                { name: "Pastetten", href: "/de/umzug-pastetten" },
                                { name: "Forstern", href: "/de/umzug-forstern" },
