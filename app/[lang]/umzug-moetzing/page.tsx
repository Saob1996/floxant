        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-moetzing` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Mötzing", href: "/de/umzug-moetzing" },
                                { name: "Sünching", href: "/de/umzug-suenching" },
                                { name: "Riekofen", href: "/de/umzug-riekofen" },
                                ...
                                { name: "Schönach", href: "/de/umzug-schoenach" },
