        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-ansbach`,
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-ansbach` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                ...
                <section className="bg-slate-50 py-16 px-6 border-t border-border">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                { name: "Ansbach", href: "/de/umzug-ansbach" },
                                { name: "Nürnberg", href: "/de/umzug-nuernberg" },
                                { name: "Gunzenhausen", href: "/de/umzug-gunzenhausen" },
                                { name: "Rothenburg ob der Tauber", href: "/de/umzug-rothenburg-ob-der-tauber" },
                                { name: "Dinkelsbühl", href: "/de/umzug-dinkelsbuehl" },
                                { name: "Feuchtwangen", href: "/de/umzug-feuchtwangen" },
                                { name: "Heilsbronn", href: "/de/umzug-heilsbronn" },
                                { name: "Neuendettelsau", href: "/de/umzug-neuendettelsau" },
                                { name: "Windsbach", href: "/de/umzug-windsbach" },
                                { name: "Sachs", href: "/de/umzug-sachsen-bei-ansbach" },
                                { name: "Petersaurach", href: "/de/umzug-petersaurach" },
                                { name: "Lichtenau", href: "/de/umzug-lichtenau" },
                                { name: "Wolframs-Eschenbach", href: "/de/umzug-wolframs-eschenbach" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
