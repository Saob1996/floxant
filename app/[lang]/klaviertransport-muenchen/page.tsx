...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({
        ...
        description: "Klaviertransport, Flügeltransport und Tresortransport in München. Spezialisiertes Equipment, geschultes Team, volle Versicherung. Jetzt anfragen!",
    });
}
