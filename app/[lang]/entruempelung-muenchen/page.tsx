...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const serviceJsonLd = {
        ...
        "provider": { "@type": "LocalBusiness", "name": "FLOXANT Entrümpelung München", "telephone": "+4915771105087" },
        "areaServed": { "@type": "City", "name": "München" }
    };
            ...
            <section className="pt-8 pb-20 px-6 bg-gradient-to-b from-muted/20 to-background">
                <div className="max-w-7xl mx-auto text-center space-y-8">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-foreground">
                        Entrümpelung in <span className="text-primary">München</span>
                    </h1>
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        FLOXANT bietet professionelle Entrümpelung in München und Umgebung. Ob Wohnungsauflösung, Kellerentrümpelung oder Dachbodenräumung – wir erledigen alles schnell, sauber und zu fairen Festpreisen.
                    </p>
                </div>
            </section>
            ...
            <section className="py-20 px-6">
                <div className="max-w-4xl mx-auto space-y-16">
                    <div className="prose prose-lg max-w-none text-muted-foreground">
                        <h2 className="text-3xl font-bold text-foreground mb-6">Entrümpelung in München – schnell & sauber</h2>
                        <p>Unsere erfahrenen Teams räumen Wohnungen, Keller, Dachböden und Büros in München professionell. Verwertbare Gegenstände werden gegengerechnet, alles andere umweltgerecht entsorgt.</p>
                    </div>
