...
export default async function EntruempelungMuenchenPage({ params }: PageProps) {
    const { lang } = await params;
        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/entruempelung-muenchen` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Fürstenfeldbruck", href: "/de/entruempelung-fuerstenfeldbruck" },
                                { name: "Erding", href: "/de/entruempelung-erding" },
                                { name: "Germering", href: "/de/entruempelung-germering" },
                                { name: "Unterschleißheim", href: "/de/entruempelung-unterschleissheim" },
                                { name: "Olching", href: "/de/entruempelung-olching" },
                                { name: "Garching", href: "/de/entruempelung-garching" },
                                { name: "Puchheim", href: "/de/entruempelung-puchheim" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
