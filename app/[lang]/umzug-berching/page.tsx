        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-berching` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Berching", href: "/de/umzug-berching" },
                                { name: "Dietfurt", href: "/de/umzug-dietfurt" },
                                { name: "Beilngries", href: "/de/umzug-beilngries" },
                                { name: "Freystadt", href: "/de/umzug-freystadt" },
                                { name: "Greding", href: "/de/umzug-greding" },
                                { name: "Mühlhausen", href: "/de/umzug-muehlhausen" },
                                { name: "Breitenbrunn", href: "/de/umzug-breitenbrunn" },
                                { name: "Deining", href: "/de/umzug-deining" },
                                { name: "Sengenthal", href: "/de/umzug-sengenthal" },
                                { name: "Hilpoltstein", href: "/de/umzug-hilpoltstein" },
                                { name: "Thalmässing", href: "/de/umzug-thalmaessing" },
                                { name: "Berngau", href: "/de/umzug-berngau" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
