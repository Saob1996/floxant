...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_neufahrn_in_niederbayern",
        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-neufahrn-in-niederbayern` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Neufahrn", href: "/de/umzug-neufahrn-in-niederbayern" },
                                { name: "Ergoldsbach", href: "/de/umzug-ergoldsbach" },
                                { name: "Rottenburg am Laaber", href: "/de/umzug-rottenburg-an-der-laaber" },
                                { name: "Pfeffenhausen", href: "/de/umzug-pfeffenhausen" },
                                { name: "Hohenthann", href: "/de/umzug-hohenthann" },
                                { name: "Obersüßbach", href: "/de/umzug-obersuessbach" },
                                { name: "Bayerbach", href: "/de/umzug-bayerbach-bei-ergoldsbach" },
                                { name: "Wörth", href: "/de/umzug-woerth-an-der-isar" },
                                { name: "Niederaichbach", href: "/de/umzug-niederaichbach" },
                                { name: "Moosburg", href: "/de/umzug-moosburg" },
