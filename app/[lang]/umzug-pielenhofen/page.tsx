        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-pielenhofen` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Brunn", href: "/de/umzug-brunn" },
                                { name: "Laaber", href: "/de/umzug-laaber" },
                                { name: "Lappersdorf", href: "/de/umzug-lappersdorf" },
                                { name: "Zeitlarn", href: "/de/umzug-zeitlarn" },
                                { name: "Deuerling", href: "/de/umzug-deuerling" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
