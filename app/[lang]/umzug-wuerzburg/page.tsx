...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_wuerzburg",
        city: "Würzburg",
    });

    return generatePageSEO({
        pageLocale: lang,
        path: `umzug-wuerzburg`,
        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-wuerzburg`,
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-wuerzburg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Aschaffenburg", href: "/de/umzug-aschaffenburg" },
                                { name: "Wertheim", href: "/de/umzug-wertheim" },
                                { name: "Lohr am Main", href: "/de/umzug-lohr-am-main" },
                                { name: "Kitzingen", href: "/de/umzug-kitzingen" },
                                { name: "Ochsenfurt", href: "/de/umzug-ochsenfurt" },
                                { name: "Karlstadt", href: "/de/umzug-karlstadt" },
                                { name: "Veitshöchheim", href: "/de/umzug-veitshoechheim" },
                                { name: "Höchberg", href: "/de/umzug-hoechberg" },
                                { name: "Rimpar", href: "/de/umzug-rimpar" },
                                { name: "Gerbrunn", href: "/de/umzug-gerbrunn" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
