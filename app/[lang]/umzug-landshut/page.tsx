...
export default async function UmzugLandshut({ params }: { params: Promise<{ lang: string }> }) {
    ...
    return (
        <main className="min-h-screen bg-background">
            ...
            `FLOXANT ist Ihr starker Umzugspartner für Landshut. Wir bieten {dict.calculator?.fixed_price_tag}, voll versicherten Transport und lokale Expertise für Privathaushalte und Firmen.`
          </p>
