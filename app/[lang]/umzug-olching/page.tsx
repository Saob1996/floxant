        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-olching` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Esting", href: "/de/umzug-esting" },
                                { name: "Geiselbullach", href: "/de/umzug-geiselbullach" },
                                { name: "Dachau", href: "/de/umzug-dachau" },
                                { name: "München", href: "/de/umzug-muenchen" },
                                { name: "Karlsfeld", href: "/de/umzug-karlsfeld" },
                                { name: "Aubing", href: "/de/umzug-aubing" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
