        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-hagelstadt` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Mintraching", href: "/de/umzug-mintraching" },
                                { name: "Köfering", href: "/de/umzug-koefering" },
                                { name: "Pfakofen", href: "/de/umzug-pfakofen" },
                                { name: "Aufhausen", href: "/de/umzug-aufhausen" },
                                { name: "Sünching", href: "/de/umzug-suenching" },
