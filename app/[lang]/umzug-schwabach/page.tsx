        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-schwabach` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Kammerstein", href: "/de/umzug-kammerstein" },
                                { name: "Abenberg", href: "/de/umzug-abenberg" },
                                { name: "Büchenbach", href: "/de/umzug-buechenbach" },
                                { name: "Rohr", href: "/de/umzug-rohr" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
