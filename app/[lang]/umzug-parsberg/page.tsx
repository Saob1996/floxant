        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-parsberg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Lauterhofen", href: "/de/umzug-lauterhofen" },
                                { name: "Deining", href: "/de/umzug-deining" },
                                { name: "Pilsach", href: "/de/umzug-pilsach" },
                                { name: "Beratzhausen", href: "/de/umzug-beratzhausen" },
                                { name: "Hemau", href: "/de/umzug-hemau" },
                                { name: "Kastl", href: "/de/umzug-kastl" },
                                { name: "Ursensollen", href: "/de/umzug-ursensollen" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
