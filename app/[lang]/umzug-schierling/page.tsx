        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-schierling` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Pfakofen", href: "/de/umzug-pfakofen" },
                                { name: "Hagelstadt", href: "/de/umzug-hagelstadt" },
                                { name: "Alteglofsheim", href: "/de/umzug-alteglofsheim" },
                                { name: "Thalmassing", href: "/de/umzug-thalmassing" },
                                { name: "Mallersdorf-Pfaffenberg", href: "/de/umzug-mallersdorf-pfaffenberg" },
                                ...
                                { name: "Obertraubling", href: "/de/umzug-obertraubling" },
