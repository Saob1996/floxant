...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_guenzburg",
        city: "Günzburg",
    });

    return generatePageSEO({
        pageLocale: lang,
        path: `umzug-guenzburg`,
        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-guenzburg`,
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-guenzburg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                ...
                <section className="bg-slate-50 py-16 px-6 border-t border-border">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                { name: "Günzburg", href: "/de/umzug-guenzburg" },
                                { name: "Leipheim", href: "/de/umzug-leipheim" },
                                { name: "Burgau", href: "/de/umzug-burgau" },
                                { name: "Ichenhausen", href: "/de/umzug-ichenhausen" },
                                { name: "Jettingen-Scheppach", href: "/de/umzug-jettingen-scheppach" },
                                { name: "Offingen", href: "/de/umzug-offingen" },
                                { name: "Neu-Ulm", href: "/de/umzug-neu-ulm" },
                                { name: "Ulm", href: "/de/umzug-ulm" },
                                { name: "Langenau", href: "/de/umzug-langenau" },
                                { name: "Dillingen", href: "/de/umzug-dillingen-an-der-donau" },
                                { name: "Lauingen", href: "/de/umzug-lauingen-donau" },
                                { name: "Krumbach", href: "/de/umzug-krumbach-schwaben" },
