        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-ergoldsbach` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Essenbach", href: "/de/umzug-essenbach" },
                                { name: "Bayerbach", href: "/de/umzug-bayerbach" },
                                { name: "Wörth an der Isar", href: "/de/umzug-woerth-an-der-isar" },
                                { name: "Postau", href: "/de/umzug-postau" },
                                { name: "Niederaichbach", href: "/de/umzug-niederaichbach" },
                                { name: "Altheim", href: "/de/umzug-altheim" },
                                { name: "Gündlkofen", href: "/de/umzug-guendlkofen" },
                                { name: "Bruckberg", href: "/de/umzug-bruckberg" },
                                { name: "Vilsbiburg", href: "/de/umzug-vilsbiburg" },
                                { name: "Moosthenning", href: "/de/umzug-moosthenning" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
