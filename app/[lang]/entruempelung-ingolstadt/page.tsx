...
import { Truck, Shield, Briefcase, Star, Clock } from "lucide-react";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        seoKey: "entruempelung_ingolstadt",
        city: "Ingolstadt",
    });

    return generatePageSEO({
        pageLocale: lang,
        path: `entruempelung-ingolstadt`,
        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/entruempelung-ingolstadt` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
