        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-nittenau` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Nittenau", href: "/de/umzug-nittenau" },
                                { name: "Bruck in der Oberpfalz", href: "/de/umzug-bruck-in-der-oberpfalz" },
                                { name: "Bodenwöhr", href: "/de/umzug-bodenwoehr" },
                                { name: "Schwandorf", href: "/de/umzug-schwandorf" },
                                { name: "Maxhütte-Haidhof", href: "/de/umzug-maxhuette-haidhof" },
                                { name: "Burglengenfeld", href: "/de/umzug-burglengenfeld" },
                                { name: "Teublitz", href: "/de/umzug-teublitz" },
                                { name: "Neunburg vorm Wald", href: "/de/umzug-neunburg-vorm-wald" },
                                { name: "Bernhardswald", href: "/de/umzug-bernhardswald" },
                                { name: "Regenstauf", href: "/de/umzug-regenstauf" },
                                { name: "Walderbach", href: "/de/umzug-walderbach" },
                                { name: "Reichenbach", href: "/de/umzug-reichenbach" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
