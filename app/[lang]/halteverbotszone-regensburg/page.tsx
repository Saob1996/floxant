...
const PATH = "halteverbotszone-regensburg";
...
export async function generateMetadata({
    ...
    const { content, fallback, seoContent, seoFallback, city } =
        await getSpecialtyPageData({
            locale: pageLocale,
            baseKey: "halteverbotszone",
            seoKey: "halteverbotszone_regensburg",
            city: CITY,
        });
...
export default async function HalteverbotszoneRegensburgPage({
    params,
}: {
    params: Promise<{ lang: string }>;
}) {
    ...
    const heroTitle =
        resolveField(content.hero_h1, fallback.hero_h1) || "Halteverbotszone";
