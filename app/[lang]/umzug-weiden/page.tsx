        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-weiden` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Neustadt an der Waldnaab", href: "/de/umzug-neustadt-an-der-waldnaab" },
                                { name: "Vohenstrauß", href: "/de/umzug-vohenstrauss" },
                                { name: "Windischeschenbach", href: "/de/umzug-windischeschenbach" },
                                { name: "Grafenwöhr", href: "/de/umzug-grafenwoehr" },
                                { name: "Pressath", href: "/de/umzug-pressath" },
                                { name: "Eslarn", href: "/de/umzug-eslarn" },
                                { name: "Luhe-Wildenau", href: "/de/umzug-luhe-wildenau" },
                                { name: "Wernberg-Köblitz", href: "/de/umzug-wernberg-koeblitz" },
                                { name: "Pfreimd", href: "/de/umzug-pfreimd" },
                                { name: "Nabburg", href: "/de/umzug-nabburg" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
