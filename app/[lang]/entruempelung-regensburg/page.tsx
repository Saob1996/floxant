...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        seoKey: "entruempelung_regensburg",
        city: "Regensburg",
    });
        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/entruempelung-regensburg` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Schwandorf", href: "/de/entruempelung-schwandorf" },
                                { name: "Amberg", href: "/de/entruempelung-amberg" },
                                { name: "Neumarkt", href: "/de/entruempelung-neumarkt" },
                                { name: "Straubing", href: "/de/entruempelung-straubing" },
                                { name: "Kelheim", href: "/de/entruempelung-kelheim" },
                                { name: "Lappersdorf", href: "/de/entruempelung-lappersdorf" },
                                { name: "Wenzenbach", href: "/de/entruempelung-wenzenbach" },
                                { name: "Neutraubling", href: "/de/entruempelung-neutraubling" },
                                { name: "Burglengenfeld", href: "/de/entruempelung-burglengenfeld" },
                                { name: "Maxhütte-Haidhof", href: "/de/entruempelung-maxhuette-haidhof" },
                                { name: "Regenstauf", href: "/de/entruempelung-regenstauf" }
                            ].map((loc) => (
                                <Link 
                                    key={loc.name} 
                                    href={loc.href}
