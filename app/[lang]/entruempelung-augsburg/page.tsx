...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const localBusinessJsonLd = {
        ...
        "url": `https://www.floxant.de/${pageLocale}/entruempelung-augsburg`,
    ...
    const breadcrumbsJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Entrümpelung Augsburg", "item": `https://www.floxant.de/${pageLocale}/entruempelung-augsburg` }
        ]
    };

    return (
        <main className="min-h-screen bg-background">
            <Breadcrumbs pageLocale={pageLocale} items={[{ label: "Entrümpelung Bayern", href: `/${pageLocale}/entruempelung-bayern` }, { label: "Entrümpelung Augsburg" }]} />
