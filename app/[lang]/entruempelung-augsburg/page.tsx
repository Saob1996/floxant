...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return generatePageSEO({ lang, path: 'entruempelung-augsburg', title: 'Entrümpelung Augsburg | Wohnungsauflösung | FLOXANT', description: 'Professionelle Entrümpelung in Augsburg. Wohnungsauflösung, Kellerentrümpelung, Sperrmüll. Festpreis & umweltgerechte Entsorgung.' });
}
...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const faqJsonLd = {
        ...
        "mainEntity": [
            { "@type": "Question", "name": "Was kostet eine Entrümpelung in Augsburg?", "acceptedAnswer": { "@type": "Answer", "text": "30 bis 80 Euro pro Kubikmeter, abhängig von Material und Zugänglichkeit. Festpreis nach Besichtigung." } },
    ...
    const localBusinessJsonLd = {
        ...
        "name": "FLOXANT Entrümpelung Augsburg",
        "url": `https://www.floxant.de/${lang}/entruempelung-augsburg`,
    ...
    const serviceJsonLd = {
        ...
        "provider": { "@type": "LocalBusiness", "name": "FLOXANT Entrümpelung Augsburg", "telephone": "+4915771105087" },
        "areaServed": { "@type": "City", "name": "Augsburg" }
    };
    ...
    const breadcrumbsJsonLd = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Entrümpelung Augsburg", "item": `https://www.floxant.de/${lang}/entruempelung-augsburg` }
        ]
    };
    ...
    return (
        <main className="min-h-screen bg-background">
            ...
            <Breadcrumbs lang={lang} items={[{ label: "Entrümpelung Bayern", href: `/${lang}/entruempelung-bayern` }, { label: "Entrümpelung Augsburg" }]} />
            ...
            <section className="pt-8 pb-20 px-6 bg-gradient-to-b from-muted/20 to-background">
                <div className="max-w-7xl mx-auto text-center space-y-8">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-foreground">
                        Entrümpelung in <span className="text-primary">Augsburg</span>
                    </h1>
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        FLOXANT bietet professionelle Entrümpelung in Augsburg und Umgebung. Ob Wohnungsauflösung, Kellerentrümpelung oder Dachbodenräumung – wir erledigen alles schnell, sauber und zu fairen Festpreisen.
                    </p>
                </div>
            </section>
            ...
            <section className="py-20 px-6">
                <div className="max-w-4xl mx-auto space-y-16">
                    <div className="prose prose-lg max-w-none text-muted-foreground">
                        <h2 className="text-3xl font-bold text-foreground mb-6">Entrümpelung in Augsburg – schnell & sauber</h2>
                        <p>Unsere erfahrenen Teams räumen Wohnungen, Keller, Dachböden und Büros in Augsburg professionell. Verwertbare Gegenstände werden gegengerechnet, alles andere umweltgerecht entsorgt.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            {[
                            { q: "Was kostet eine Entrümpelung in Augsburg?", a: "30 bis 80 Euro pro Kubikmeter, abhängig von Material und Zugänglichkeit. Festpreis nach Besichtigung." },
                    ...
                    <div className="text-center py-10 bg-gradient-to-br from-primary/5 via-transparent to-primary/5 rounded-3xl border border-primary/10 shadow-lg">
                        <h2 className="text-3xl font-bold mb-4">Entrümpelung in Augsburg anfragen</h2>
                        <p className="text-muted-foreground mb-8 max-w-xl mx-auto">Kostenloses Festpreisangebot für Entrümpelung in Augsburg.</p>
