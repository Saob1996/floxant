...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_forchheim",
        city: "Forchheim",
    });

    return generatePageSEO({
        pageLocale: lang,
        path: `umzug-forchheim`,
        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-forchheim`,
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-forchheim` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Eggolsheim", href: "/de/umzug-eggolsheim" },
                                { name: "Heroldsbach", href: "/de/umzug-heroldsbach" },
                                { name: "Hausen", href: "/de/umzug-hausen" },
                                { name: "Kirchehrenbach", href: "/de/umzug-kirchehrenbach" },
                                { name: "Weilersbach", href: "/de/umzug-weilersbach" },
                                { name: "Hallerndorf", href: "/de/umzug-hallerndorf" },
