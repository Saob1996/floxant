        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-freising` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Neufahrn bei Freising", href: "/de/umzug-neufahrn-bei-freising" },
                                { name: "Eching", href: "/de/umzug-eching" },
                                { name: "Hallbergmoos", href: "/de/umzug-hallbergmoos" },
                                { name: "Allershausen", href: "/de/umzug-allershausen" },
                                { name: "Attenkirchen", href: "/de/umzug-attenkirchen" },
                                { name: "Zolling", href: "/de/umzug-zolling" },
                                { name: "Marzling", href: "/de/umzug-marzling" },
                                { name: "Langenbach", href: "/de/umzug-langenbach" },
                                { name: "Kranzberg", href: "/de/umzug-kranzberg" },
