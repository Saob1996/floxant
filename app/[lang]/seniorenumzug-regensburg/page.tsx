...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    const content = dict?.pages?.seniorenumzug_regensburg || {};
    return generatePageSEO({
        pageLocale,
        path: "seniorenumzug-regensburg",
        title: content.meta_title || "Seniorenumzug Regensburg – Einfühlsam & Sicher | FLOXANT",
        description: content.meta_desc || `Seniorenumzug in Regensburg: Kompletter Einpackservice, Möbelmontage, Behördenhilfe. Empathisches Team, fester Preis, volle Versicherung. Jetzt beraten lassen! Sofortpreis online berechnen oder bequem per WhatsApp / Telefon anfragen: +49 1577 1105087.`,
    });
}
...
export default async function SeniorenumzugPage({ params }: { params: Promise<{ lang: string }> }) {
    ...
    return (
        <main className="min-h-screen bg-background">
            <Breadcrumbs pageLocale={pageLocale} items={[{ label: "Umzug Regensburg", href: "/" + pageLocale + "/umzug-regensburg" }, { label: "Seniorenumzug Regensburg" }]} />
            ...
            <section className="py-16 px-6">
                <div className="max-w-4xl mx-auto space-y-12">
                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                        ...
                        <Link href={"/" + pageLocale + "/klaviertransport-regensburg"} className="px-5 py-3 rounded-2xl border border-border/50 bg-card text-sm font-semibold hover:border-primary/50 transition-all">Klaviertransport Regensburg</Link>
