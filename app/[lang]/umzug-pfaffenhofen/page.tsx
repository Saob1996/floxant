        ...
        "@graph": [
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-pfaffenhofen` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Scheyern", href: "/de/umzug-scheyern" },
                                { name: "Hettenshausen", href: "/de/umzug-hettenshausen" },
                                { name: "Ilmmünster", href: "/de/umzug-ilmmuenster" },
