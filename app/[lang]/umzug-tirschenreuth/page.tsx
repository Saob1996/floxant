...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const { seoContent, seoFallback, city } = await getSpecialtyPageData({
        ...
        baseKey: "umzug_spec",
        seoKey: "umzug_tirschenreuth",
        city: "Tirschenreuth",
    });

    return generatePageSEO({
        pageLocale: lang,
        path: `umzug-tirschenreuth`,
        ...
        "@graph": [
            {
                ...
                "description": resolveField(seoContent.meta_desc, seoFallback.meta_desc, city),
                "url": `https://www.floxant.de/${lang}/umzug-tirschenreuth`,
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 3, "name": city, "item": `https://www.floxant.de/${lang}/umzug-tirschenreuth` }
                ]
            },
            ...(faqItems.length > 0 ? [{
                "@type": "FAQPage",
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { name: "Hof", href: "/de/umzug-hof" },
                                { name: "Tirschenreuth", href: "/de/umzug-tirschenreuth" },
                                { name: "Weiden", href: "/de/umzug-weiden" },
                                { name: "Wiesau", href: "/de/umzug-wiesau" },
                                { name: "Mitterteich", href: "/de/umzug-mitterteich" },
                                { name: "Waldsassen", href: "/de/umzug-waldsassen" },
                                { name: "Kemnath", href: "/de/umzug-kemnath" },
